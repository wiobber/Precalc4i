...
\[ \begin{array}{rcl} \dfrac{\sec(t)}{1 - \tan(t)} & = & \dfrac{ \dfrac{1}{\cos(t)}}{1 - \dfrac{\sin(t)}{\cos(t)}} = \dfrac{ \dfrac{1}{\cos(t)}}{1 - \dfrac{\sin(t)}{\cos(t)}} \cdot \dfrac{\cos(t)}{\cos(t)} \\  
 & = & \dfrac{\left( \dfrac{1}{\cos(t)} \right) ( \cos(t) )}{\left(1 - \dfrac{\sin(t)}{\cos(t)}\right)(\cos(t))} = \dfrac{1}{(1)(\cos(t)) - \left(\dfrac{\sin(t)}{\cos(t)}\right)(\cos(t))} \\  
...
\dfrac{3}{1-\sin(x)} - \dfrac{3}{1 + \sin(x)} & = & \dfrac{3(1 + \sin(x))}{(1-\sin(x))(1 + \sin(x))} - \dfrac{3(1-\sin(x))}{(1 + \sin(x))(1-\sin(x))} \\  
                                                        & = & \dfrac{3 + 3\sin(x)}{1 - \sin^{2}(x)} - \dfrac{3 - 3\sin(x)}{1 - \sin^{2}(x)} \\  
                                                        & = & \dfrac{(3 + 3\sin(x)) - (3 - 3\sin(x))}{1 - \sin^{2}(x)} \\                                                          																																	
...
\dfrac{3}{1-\sin(x)} - \dfrac{3}{1 + \sin(x)} & = & \dfrac{6 \sin(x)}{1 - \sin^{2}(x)}= \dfrac{6 \sin(x)}{\cos^{2}(x)} \\  
...
\dfrac{\sin(\theta)}{1 - \cos(\theta)} & = & \dfrac{\sin(\theta)}{(1 - \cos(\theta))} \cdot \dfrac{(1 + \cos(\theta))}{(1 + \cos(\theta))} = \dfrac{\sin(\theta)(1 + \cos(\theta))}{(1 - \cos(\theta))(1 + \cos(\theta))} \\  
& = & \dfrac{\sin(\theta)(1 + \cos(\theta))}{1 - \cos^{2}(\theta)} = \dfrac{\sin(\theta)(1 + \cos(\theta))}{\sin^{2}(\theta)} \\  
