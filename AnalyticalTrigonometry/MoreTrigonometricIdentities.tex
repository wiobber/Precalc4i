...
\tlabel[cc](0.25,.95){\scriptsize $\alpha_0$}
\tlabel[cc](0.95,0.3){\scriptsize $\beta_0$}
...
\point {(0,0), (3,0), (2.121, 2.121), (-1.5, 2.598) }
\tlabel(-4.5,2.5){\scriptsize $P(\cos(\alpha_0),\sin(\alpha_0))$}
\tlabel(2.5,2){\scriptsize $Q(\cos(\beta_0),\sin(\beta_0))$}
\penwd{1.5pt}
\arrow \parafcn{50, 115,5}{1.75*dir(t)}
\tlabel(0.1,1.9){\mbox{\scriptsize \boldmath $\alpha_0 - \beta_0$}}
\penwd{1.25pt}
...
\tlabel(1.25,2.8){\scriptsize $A(\cos(\alpha_0 - \beta_0),\sin(\alpha_0 - \beta_0))$}
\tlabel(2.25,-0.5){\scriptsize $B(1,0)$}
\dotted \polyline{(3,0), (1.026, 2.819)}
\point {(0,0), (3,0), (1.026, 2.819)}
\penwd{1.5pt}
\arrow \parafcn{5, 65,5}{1.75*dir(t)}
\tlabel(0.2,0.3){\mbox{\scriptsize \boldmath $\alpha_0 - \beta_0$}}
\penwd{1.25pt}
