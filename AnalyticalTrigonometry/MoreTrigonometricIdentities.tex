...
\tlabel(1.5,-1){$\theta$}
\tlabel[cc](-2.5, 2.75){\mbox{\boldmath $\theta_0$}}
\point {(0,0),(-2.7692, 1.1538)}
\penwd{1.25pt}
...
\point {(0,0),(-2.7692, 1.1538)}
\point {(0,0),(-2.7692, -1.1538)}
\tlabel(-7,0.75){\scriptsize $P(\cos(\theta_0),\sin(\theta_0))$}
\tlabel(-7.5,-0.85){\scriptsize $Q(\cos(-\theta_0),\sin(-\theta_0))$}
\penwd{1.25pt}
\arrow \reverse \arrow \polyline{(5,0), (0,0), (-4.6154, 1.9231)}
\arrow \reverse \arrow \polyline{(5,0), (0,0), (-4.6154, -1.9231)}
\penwd{1.5pt}
