...
\begin{tikzpicture}[x=20pt,y=20pt]
  ...
  \node at (3,0.5) {$(+)$};
   ...
   \node at (9,0.5) {$(-)$};
    \node at (0,-0.5) {$0$};
   \node at (2,-0.5) {$\arctan(3)$};
   \node at (4,-0.5) {$\pi/2$};
   \node at (6,-0.5) {$\arctan(3)+\pi$};
    \node at (8,-0.5) {$3\pi/2$};
   \node at (10,-0.5) {$2\pi$};
\end{tikzpicture}
\end{image}
...
{ $y = 3 \, \text{arcsec}(2x-1) + \pi$} and $y = 2\pi$  
...
{  $y=4\arctan^2(t)-3\pi \arctan(t)-\pi^2$ } and $y=0$.\\
...
{ $x(t) = 10e^{-t/5} \sin\left(t + \frac{\pi}{3}\right)$} and $x= \pm 10e^{-t/5}$ \\
...
{ $x(t)= 2(t+3) \sin\left(2t + \frac{\pi}{4}\right)$} and $x = \pm 2(t+3)$ \\
...
{ $x(t) = 5\sin(6t) - 5\sin(8t)$} and  $x = \pm 10 \sin(t)$ over $[0,\pi]$
