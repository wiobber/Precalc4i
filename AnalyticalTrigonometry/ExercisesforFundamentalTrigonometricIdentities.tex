...
\begin{problem}
    $\cot(t) = 2$ with $0  < t < \dfrac{\pi}{2}$.
\end{problem}

\begin{problem}
    $\csc(t) = 5$ with $\dfrac{\pi}{2} < t < \pi$.
\end{problem}

\begin{problem}
    $\tan(t) = \sqrt{10}$ with $\pi < t < \dfrac{3\pi}{2}$.
\end{problem}

\begin{problem}\label{useidsforvalueslast02}
     $\sec(t) = 2\sqrt{5}$ with $\dfrac{3\pi}{2} < t < 2\pi$.
\end{problem}
...
\begin{problem}
    $\dfrac{\sin(t)}{\cos^{2}(t)} = \sec(t) \tan(t)$
\end{problem}
...
\begin{problem}
     $\dfrac{\cos(t)}{1 - \sin^{2}(t)} = \sec(t)$
\end{problem}

\begin{problem}
    $\dfrac{\sin(x)}{1 - \cos^{2}(x)} = \csc(x)$
\end{problem}
...
\begin{problem}
    $\dfrac{\tan(x)}{\sec^{2}(x) - 1} = \cot(x)$
\end{problem}

\begin{problem}
    $\dfrac{\cot(t)}{\csc^{2}(t) - 1} = \tan(t)$
\end{problem}
...
\begin{problem}
    $\dfrac{\sin(t) + 1}{\sin(t) - 1} = \dfrac{1 + \csc(t)}{1 - \csc(t)}$
\end{problem}
...
\begin{problem}
    $\dfrac{1 - \tan(t)}{1+ \tan(t)} = \dfrac{\cos(t) - \sin(t)}{\cos(t) + \sin(t)}$
\end{problem}
...
\begin{problem}
    $\dfrac{1}{\sec(t) + 1} + \dfrac{1}{\sec(t)-1} = 2 \csc(t) \cot(t)$
\end{problem}

\begin{problem}
    $\dfrac{1}{\csc(x) + 1} + \dfrac{1}{\csc(x)-1} = 2 \sec(x) \tan(x)$
\end{problem}

\begin{problem}
    $\dfrac{1}{\csc(t)-\cot(t)} - \dfrac{1}{\csc(t) + \cot(t)} = 2 \cot(t)$
\end{problem}
...
\begin{problem}
    $\dfrac{1}{\sec(t) + \tan(t)} = \sec(t) - \tan(t)$
\end{problem}

\begin{problem}
    $\dfrac{1}{\sec(x) - \tan(x)} = \sec(x) + \tan(x)$
\end{problem}

\begin{problem}
    $\dfrac{1}{\csc(t) - \cot(t)} = \csc(t) + \cot(t)$
\end{problem}
...
\begin{problem}
    $\dfrac{1}{1-\sin(x)} = \sec^{2}(x) + \sec(x) \tan(x)$
\end{problem}

\begin{problem}
    $\dfrac{1}{1+\sin(t)} = \sec^{2}(t) - \sec(t) \tan(t)$
\end{problem}
...
\begin{problem}
    $\dfrac{1}{1+\cos(x)} = \csc^{2}(x) - \csc(x) \cot(x)$
\end{problem}

\begin{problem}
    $\dfrac{\cos(t)}{1 + \sin(t)} = \dfrac{1-\sin(t)}{\cos(t)}$
\end{problem}
