...
\begin{definition} \label{nthrootcomplex} Let $z$ and $w$ be complex numbers.  If there is a natural number $n$ such that $w^{n} = z$, then $w$ is an \textbf{\boldmath $n^{\mbox{\textbf{th}}}$ root} of $z$. \index{$n^{\textrm{th}}$ root ! of a complex number} \index{complex number ! $n^{\textrm{th}}$ root} 
...
%% \colorbox{ResultColor}{\bbm
\begin{theorem} \label{nthrootscomplexthm} \textbf{The \boldmath $n^{\mbox{\textbf{th}}}$ roots of a Complex Number:}
