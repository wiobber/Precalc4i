...
\draw[dashed] (3,4) -- (-4,4);
\draw[dashed] (0,0) -- (3,4);
\node at (3.75,4){\scriptsize $P(r,\theta)$};
\node at (0,0) {*};
\fill (3,4) circle (2pt);
\draw[<->] (-4,-0.5) -- (-4,6);
\draw[<->] (0.25,4.5) -- (2.75,4.5);
\draw[<->] (-3.75,4.5) -- (-0.25,4.5);
\node at (-4,-1) {\scriptsize $x = -d$}
\node at (1.5,4.75) {\scriptsize $r\cos(\theta)$};
\node at (-2.5, 5) {\scriptsize $d$};
\node at (0.75,-0.5) {\scriptsize $O = F$};
\node at (1.75,0.75) {\scriptsize $\theta$};
\node at (1.5,2.5 ){\scriptsize $r$};
\draw[->]
    (1.5,0)
...
\plotsymbol {Asterisk}{(0, 0), (3,0)}
\plotsymbol {Cross}{(1.5,0)}
...
\point[4pt]{(0,2), (0,6)}
\plotsymbol {Asterisk}{(0, 0), (0,8)}
\plotsymbol {Cross}{(0,4)}
