...
\node at (1.5,5) {\scriptsize $P(x,y) = P(x',y')$};

%Rotation arc
\draw[->]
    (3,0)
    arc[start angle=0,end angle=40,radius=3];
\node at (3.25, 1.25) {\scriptsize $\theta$};
\draw[->]
    (0,3)
    arc[start angle=90,end angle=130,radius=3];
\node at (-1.25, 3.25) {\scriptsize $\theta$};

\draw[->]
    (2.12, 2.12)
    arc[start angle=50,end angle=75,radius=3];
\node at (2, 2.75) {\scriptsize $\phi$};
...
\node at (2,-4.5) {\scriptsize $P(x,y) = (2, -4)$};
\node at (2,-5) {\scriptsize $P(x',y') \approx (-2.46,-3.73)$};
\fill (2,-4) circle (2pt);
%Rotation arc
\draw[->]
    (3,0)
    arc[start angle=0,end angle=50,radius=3];
\node at (3.5, 1.25) {\scriptsize $\theta = \frac{\pi}{3}$};
\draw[->]
    (0,3)
    arc[start angle=90,end angle=145,radius=3];
\node at (-1.25, 3.25) {\scriptsize $\theta = \frac{\pi}{3}$};
