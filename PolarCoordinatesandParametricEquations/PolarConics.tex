...
\draw[->] (-5,0) -- (5,0);
\draw[->] (0,-5) -- (0,5);
\node at (5.5, 0) {\small $x$};
\node at (0, 5.5) {\small $y$};
\node at (1.5,5) {\small $P(x,y) = P(x',y')$};

%Rotation arc
\draw[->]
    (3,0)
    arc[start angle=0,end angle=40,radius=3];
\node at (3.25, 1.25) {\small $\theta$};
\draw[->]
    (0,3)
    arc[start angle=90,end angle=130,radius=3];
\node at (-1.25, 3.25) {\small $\theta$};

\draw[->]
    (2.12, 2.12)
    arc[start angle=50,end angle=75,radius=3];
\node at (2, 2.75) {\small $\phi$};
...
\begin{image}
\begin{tikzpicture}[scale=1.0, rotate=60, transform shape]
...
\node at (5.5, 0) {\small $x$};
\node at (0, 5.5) {\small $y$};
\node at (2, -0.5) {\scriptsize $2$};
\node at (-.5, -4) {\scriptsize $-4$};

%Rotation arc
\draw[->]
    (4,0)
    arc[start angle=0,end angle=50,radius=4];
\node at (4.25, 2) {\small $\theta = \frac{\pi}{3}$};
\draw[->]
    (0,4)
    arc[start angle=90,end angle=145,radius=4];
\node at (-2, 4.25) {\small $\theta = \frac{\pi}{3}$};
...
\begin{image}
\begin{tikzpicture}[scale=1.0, rotate=45, transform shape]
...
\node at (4.25, 1.5) {\small $\theta = \frac{\pi}{4}$};
\end{scope}
...
\begin{image}
\begin{tikzpicture}[scale=1.0, rotate=36, transform shape]
...
\node at (4, 1) {\small $\theta = \arctan\left(\frac{3}{4}\right)$};
\end{scope}
...
\draw[dashed] (3,4) -- (-4,4);
\draw[dashed] (0,0) -- (3,4);
\node at (3.75,4){\small $P(r,\theta)$};
\node at (0,0) {\large $*$};
\fill (3,4) circle (2pt);
\draw[<->] (-4,-0.5) -- (-4,6);
\draw[<->] (0.25,4.5) -- (2.75,4.5);
\draw[<->] (-3.75,4.5) -- (-0.25,4.5);
\node at (-4,-0.5) {\small $x = -d$};
\node at (1.5,4.75) {\small $r\cos(\theta)$};
\node at (-2, 4.75) {\small $d$};
\node at (0.5,-0.25) {\small $O = F$};
\node at (1.75,0.75) {\small $\theta$};
\node at (1.5,2.5 ){\small $r$};
\draw[->]
    (1.5,0)
