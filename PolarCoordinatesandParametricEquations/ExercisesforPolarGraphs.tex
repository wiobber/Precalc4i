...
\filldraw[fill=blue!20, fill opacity=0.5, draw=blue, thick]
plot[domain=90:270, samples=120, smooth] ({(1-2*cos(\x))*cos(\x)}, {(1-2*cos(\x))*sin(\x)})
plot[domain=90:270, samples=120, smooth] ({(1)*cos(\x)}, {(1))*sin(\x)})
--cycle
% Polar Graph Region
% TikZ math engine uses degrees by default
%\filldraw[fill=blue!20, fill opacity=0.5, draw=blue, thick]
%    plot[domain=90:270, samples=120, smooth] ({(1-2*cos(\x))*cos(\x)}, {(1-2*cos(\x))*sin(\x)}) -- cycle;
%\filldraw[fill=white, fill opacity=1, draw=white, thick]
%    plot[domain=90:270, samples=120, smooth] ({(1)*cos(\x)}, {(1))*sin(\x)}) -- cycle;

% Polar Graph
% TikZ math engine uses degrees by default
%\draw[dashed, blue, thick]
%    plot[domain=0:360, samples=120, smooth] ({(1-2*cos(\x))*cos(\x)}, {(1-2*cos(\x))*sin(\x)}) -- cycle;
%\draw[blue, thick]
%    plot[domain=90:270, samples=120, smooth] ({(1)*cos(\x)}, {(1)*sin(\x)});
...
% TikZ math engine uses degrees by default
\filldraw[fill=blue!20, fill opacity=0.5, draw=blue, thick]
plot[domain=300:420, samples=120, smooth] ({(3*cos(\x))*cos(\x)}, {(3*cos(\x)))*sin(\x)}) -- cycle;
    
\filldraw[fill=white, fill opacity=1, draw=white, thick]
plot[domain=300:420, samples=120, smooth] ({(1+cos(\x))*cos(\x)}, {(1+cos(\x))*sin(\x)}) -- cycle;
...
\draw[blue, thick]
 plot[domain=300:420, samples=120, smooth] ({(1+cos(\x))*cos(\x)}, {(1+cos(\x))*sin(\x)});
