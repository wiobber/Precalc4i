...
\begin{document}
	\author{Stitz-Zeager}
	\xmtitle{Answers for Polar Conics}{}

\mfpicnumber{1} \opengraphsfile{AnswersforPolarConics} % mfpic settings added 
\begin{multicols}{2}
...
\item  $r = \frac{6}{3 - \cos\left(\theta + \frac{\pi}{4}\right)}$  is the ellipse $r = \frac{6}{3 - \cos\left(\theta \right)} = \frac{2}{1 - \frac{1}{3} \cos\left(\theta \right)}$ rotated through $\phi = -\frac{\pi}{4}$
