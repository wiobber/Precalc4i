...
% Side labels
\node[below=7pt] at ($(A)!0.5!(B)$) {$b=4$};

\node[right=8pt] at ($(B)!0.5!(C)$) {$a$};
...
\node[below=7pt] at ($(A)!0.50!(C)$) {$b\approx 5.72$};
...
\node[below=8pt] at ($(A)!0.52!(C)$) {$b\approx 2.90$};
...
\tlabel[cc](5,0.15){\small $\gamma_0$}
\tlabel[cc](1.9,0.15){\small $\gamma_0$}
