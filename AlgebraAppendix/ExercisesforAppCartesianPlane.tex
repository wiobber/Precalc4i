...
Use graph paper to plot and label the points $\;A(-3, -7)$,  $\;B(1.3, -2)$,  $\;C(\pi, \sqrt{10})$,  $\;D(0, 8)$,  $\;E(-5.5, 0)$,  $\;F(-8, 4)$, $\;G(9.2, -7.8)$ and $H(7, 5)$, all in the same coordinate plane.  When finished, you can click the arrow on the right to check your answer. 
...
\begin{question}\label{quadsymmpointexercise} 
