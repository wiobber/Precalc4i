...
\begin{question}
For Problems \ref{quadsymmpointexercisefirst} to \ref{quadsymmpointexerciselast}, you should use the points you plotted in Problem \ref{cartexerciseone} above, and do the following:
...
\begin{problem}\label{quadsymmpointexercisefirst} 
    The point $A(-3, -7)$
...
\begin{problem}\label{quadsymmpointexerciselast} 
    The point $H(7, 5)$
