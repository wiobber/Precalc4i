...
\begin{document}
	\author{Stitz-Zeager}
	\xmtitle{Basic Factoring Techniques}{}
...
2x +5 = 0 & \text{or} & 3x -2 = 0 & \text{Zero Product Property} \\  
          &           &           & a = 2x+5, b = 3x-2 \\  
...
\item  $3x^2 = 35 - 16x$\vphantom{$t = \frac{1 + 4t^2}{4}$}

\item  $t = \frac{1+4t^2}{4}$

\item  $(y-1)^2 = 2(y-1)$


\item  $\frac{w^4}{3} = \frac{8w^3-12}{12} - \frac{w^2-4}{4}$
...
\frac{(y-1)^2}{(y-1)} & = & \frac{2(y-1)}{(y-1)} & \text{Divide by $(y-1)$ - this assumes $(y-1) \neq 0$}\\
y - 1 & = & 2 & \\
...
\frac{w^4}{3} & = & \frac{8w^3-12}{12} - \frac{w^2-4}{4} & \\ [5pt]

12 \left(\frac{w^4}{3}\right) & = & 12 \left(\frac{8w^3-12}{12} - \frac{w^2-4}{4} \right) & \text{Multiply by $12$}\\[8pt]
