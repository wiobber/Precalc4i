...
\choice{\begin{tikzpicture}[scale=0.75]

\begin{scope}
\clip (.875,0) circle (1);
\fill[gray!70] (.5,-.875) circle (1);
\end{scope}
...
\choice[correct]{\begin{tikzpicture}[scale=0.75]
\fill[gray!70] (0,0) circle (1);
\fill[gray!70] (.5,-.875) circle (1);
