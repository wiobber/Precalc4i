...
\item  $\left(4w -  \frac{1}{2} \right)^2$

\item  $\left[2(x+h) - (x+h)^2\right] - \left(2x - x^2 \right)$ 
...
\left(4w -  \frac{1}{2} \right)^2 & = & \left(4w -  \frac{1}{2} \right)\left(4w -  \frac{1}{2} \right) &   \\ 
& = & (4w)(4w) + (4w)\left(- \frac{1}{2}\right) + \left(- \frac{1}{2}\right)(4w) + \left(- \frac{1}{2}\right)\left(- \frac{1}{2}\right) &   \text{F.O.I.L.} \\ 
		
& = & 16w^2 - 2w - 2w +  \frac{1}{4} &   \text{Multiply} \\ 
& = & 16w^2 - 4w +  \frac{1}{4} &   \text{Combine like terms} \\ 
\end{array}\]
...
\left[2(x+h) - (x+h)^2\right] - \left(2x - x^2 \right) & = & \left[2(x+h) - \left( x^2 + 2xh + h^2\right) \right] - \left(2x - x^2 \right) &  \text{Substitute} \\    & = & \left[2x+2h - x^2-2xh-h^2\right] - \left(2x - x^2 \right) & \text{Distribute}\\ 
& = & 2x+2h - x^2-2xh-h^2 -2x + x^2 &  \text{Distribute} \\ 
 & = & 2x - 2x+2h - x^2 + x^2 -2xh-h^2&  \text{Rearrange terms}\\
 & = & 2h-2xh-h^2&  \text{Combine like terms}\\
...
\begin{array}{r}
 3 \, 2 \\
 7 \, 9 \, \overline{)\quad 2\,5\,8\,5 } \\
 \underline{-\,2\,3\,7\downarrow}  \\
 2\,1\,5 \\
 \underline{-\,1\,5\,8} \\
 5\,7
\end{array}
...
\begin{array}{r}
3 \cdot 10  \, +  \, 2 \\
7 \cdot 10  \, +  \, 9 \, \overline{)\quad 2\cdot 10^3  \, +  \, 5 \cdot 10^2  \, +  \, 8 \cdot 10  \, +  \, 5 } \\
- \,\underline{ \left( 2 \cdot 10^3 \right.  \, +  \,  3 \cdot 10^2   \, +  \, \left. 7 \cdot 10 \right)  \,   \,  \downarrow}  \\
2 \cdot 10^2  \, +   \, 1 \cdot 10  \, +  \, 5 \\ 
- \, \left( 1 \cdot 10^2 \right.  \, +   \,  5 \cdot 10  \,  +  \,\left.  8 \right) \\
5 \cdot 10   \, +  \, 7 \\
\end{array}
\]
...
\begin{array}{r}
x^2\,+\,6x\,+\,7\\
x\,-\,2 \, \overline{)\quad x^3\,+\,4x^2\,-\,5x\,-\,14} \\
 \underline{-\left(x^3\,-\,2x^2\right)}\quad\downarrow \phantom{\,-2\,14}\\
 6x^2-\,5x\phantom{\,-\,14\,}
\end{array}
\]
...
x^2\,+\,6x\,+\,7\\
x\,-\,2 \, \overline{)\quad x^3\,+\,4x^2\,-\,5x\,-\,14} \\
 \underline{-\left(x^3\,-\,2x^2\right)} \phantom{-\,5x\,-\,1}\downarrow\\
 6x^2-\,5x\phantom{\,-\,1}\downarrow\\
  \underline{-\left(6x^2\,-\,12x\right)\,}\downarrow\\
  \,7x\,-\,14 
\end{array}
\]
...
x^2\,+\,6x\,+\,7\\
x\,-\,2 \, \overline{)\quad x^3\,+\,4x^2\,-\,5x\,-\,14} \\
 \underline{-\left(x^3\,-\,2x^2\right)} \phantom{-\,5x\,-\,14}\\
 6x^2-\,5x\phantom{\,-\,14\,}\\
  \underline{-\left(6x^2\,-\,12x\right)} \phantom{-1}\\
  \,7x\,-\,14 \\
\underline{-\left(7x\,-\,14\right)} \\
 0\,\,
\end{array}
\]
...
\begin{array}{r}
\frac{2}{3}\\
3\,t\,-\,4 \, \overline{)\quad 2t\,+\,7} \\
 \underline{-\left(2t\,-\,\frac{8}{3}\right)\,}\\
 \frac{29}{3}\,\,\,
\end{array}
\]
...
\begin{array}{r}
3y\,-\,\frac{15}{2}\\
2y\,+\,5 \, \overline{)\quad \,6y^2\,+\,0y\,-\,1} \\
 \underline{-\left(\,6y^2\,+\,15y\right)} \phantom{1}\downarrow\\
 -15y-\,1\\
  \underline{-\left(-15y-\,\frac{75}{2}\right)}\\
  \frac{73}{2}
\end{array}
\]
...
\begin{array}{r}
w\,\phantom{\,-2\,14}\\
w^2\,+\,0w\,-\,\sqrt{2} \,\, \overline{)\quad w^3\,+\,0w^2\,+\,0w\,+\,0} \\
 \underline{-\left(w^3\,+\,0w^2\,+\,w\sqrt{2}\right)}\,\,\downarrow \\
 0w^2\,+\,w\sqrt{2}\,+\,0
\end{array}
\]
