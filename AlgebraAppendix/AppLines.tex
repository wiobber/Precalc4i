...
\begin{theorem}  Suppose line $L_1$ has slope $m_1$ and line $L_{\mbox{\tiny$2$}}$ has slope $m_{\mbox{\tiny$2$}}$:
...
\item $L_1$ and $L_{\mbox{\tiny$2$}}$ are parallel (written $L_1 \parallel L_{\mbox{\tiny$2$}}$) if and only if $m_1 = m_{\mbox{\tiny$2$}}$.

\item If $m_1 \neq 0$ and  $m_{\mbox{\tiny$2$}} \neq 0$ then $L_1$ and $L_{\mbox{\tiny$2$}}$ are perpendicular (written $L_1 \perp L_{\mbox{\tiny$2$}}$) if and only if $m_1 m_{\mbox{\tiny$2$}} = -1$.

\textbf{NOTE:} $m_1 m_{\mbox{\tiny$2$}} = -1$  is equivalent to $m_{\mbox{\tiny$2$}} = -\dfrac{1}{m_1}$, so that perpendicular lines have slopes which are `opposite reciprocals' of one another.
...
\tlpointsep{4pt}
\tcaption{$L_1 \parallel L_{\mbox{\tiny$2$}}$, $m_1 = m_{\mbox{\tiny$2$}}$}
\axes
...
\tlpointsep{4pt}
\axes
\tcaption{$L_1 \perp L_{\mbox{\tiny$2$}}$, $m_1 m_{\mbox{\tiny$2$}} = -1$}
