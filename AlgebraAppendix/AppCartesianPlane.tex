...
% Axes
\draw[->] (-5,0) -- (5,0) node[right] {\scriptsize $x$};
\draw[->] (0,-5) -- (0,5) node[above] {\scriptsize $y$};
...
\draw[dotted] (2,0) -- (2,-4);
\draw[dotted] (0,-4) -- (2,-4);
\node[fill,circle,inner sep=1pt,label=right:{\scriptsize $P$}] at (2,-4){}; 


% ---------- Right grid ----------
% Axes
\draw[->] (10,0) -- (20,0) node[right] {\scriptsize $x$};
\draw[->] (15,-5) -- (15,5) node[above] {\scriptsize $y$};

% Tick marks and labels on x-axis
\foreach \x in {-4,-3,-2,-1,1,2,3,4} {
  \draw (\x+15,0.15) -- (\x+15,-0.15);
  \node[below] at (\x+15,-0.15) {\scriptsize $\x$};
}

% Tick marks and labels on y-axis
\foreach \y in {-4,-3,-2,-1,1,2,3,4} {
  \draw (15.15,\y) -- (15-0.15,\y);
  \node[left] at (15-0.15,\y) {\scriptsize $\y$};
}

% Dotted lines and point P
\draw[dotted] (17,0) -- (17,-4);
\draw[dotted] (15,-4) -- (17,-4);
\node[fill,circle,inner sep=1pt,label=right:{\scriptsize $P (2,-4)$} ] at (17,-4){}; 
\draw[dotted] (11,0) -- (11,2);
\draw[dotted] (11,2) -- (15,2);
\node[fill,circle,inner sep=1pt,label=left:{\scriptsize $(-4,2)$} ] at (11,2){}; 
...
\gfill \circle{(0,0),0.1}
\tlabel[c](-1,-1){$P\left(x_0, y_0\right)$}
\gfill \circle{(4,3),0.1}
\tlabel[c](4.25,3){$Q\left(x_1, y_1\right)$}
...
\tlabel[c](4,-1){$\left(x_1, y_0\right)$}
...
\gfill \circle{(0,0),0.1}
\tlabel[c](-1,-0.9){$P\left(x_0, y_0\right)$}
\gfill \circle{(4,3),0.1}
\tlabel[c](4.25,3){$Q\left(x_1, y_1\right)$}
\polyline{(0,0), (4,3)}
