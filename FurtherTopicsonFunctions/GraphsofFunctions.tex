...
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-4, ymax=5, width=6in, height=6in,domain=-4:4]
...
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=8, ymin=-10, ymax=8,width=6in, height=4in,]
  ...
  \addplot[fgraph, only marks, black, mark=*, mark size=3pt] coordinates {(-4,-3) (-3,0) (-2,4.5) (0,0) (3,-8) (4,-6) (5,-6) (6,0) (7,5.5)};
