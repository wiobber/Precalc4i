...
\begin{axis}[fplot, xmin=-5, xmax=7.9, ymin=-10, ymax=7.9,width=6in, height=4in]
  ...
  \addplot[fgraph, only marks,black, mark=o, mark size=2pt, mark options={line width=1pt}] coordinates {(0,0)};
...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-6, ymax=6,width=5in, height=6in]
  ...
  \addplot[fgraph, only marks, mark=*, mark size=3pt] coordinates {(0,0) (4,0) (-4,0)};
