...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=5]
  \addplot[only marks, mark=*,black, mark size=1.75pt] coordinates {(-1,3) (0,-3) (4,-2) (4,1)};
...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5]
  \addplot[only marks, mark=*, mark size=2pt] coordinates {(0,0) (-3,1) (4,2) (-3,2)};
  % \node[flabel,draw=none,
  % fill=none, label=above right:{$(0,0)$}]  at (axis cs:0,0){};
  % \node[flabel,draw=none,
  % fill=none, label=above right:{$(-3,1)$}] at (axis cs:-3,1){};
  % \node[flabel,draw=none,
  % fill=none, label=above right:{$(4,2)$}]  at (axis cs:4,2){};
  % \node[flabel,draw=none,
  % fill=none, label=above right:{$(-3,2)$}] at (axis cs:-3,2){};
...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5]
  ...
  \addplot[only marks, mark=o, mark size=2pt] coordinates {(4,3)};
  \node[flabel,draw=none,
  fill=none, label=above left :{$(-2,3)$}] at (axis cs:-2,3){};
  \node[flabel,draw=none,
  fill=none, label=above right:{$(4,3)$}]  at (axis cs: 4,3){};
...
\fill[gray!60] (-3,1) rectangle (4,4.7);
...
\foreach \x/\lab in {-4/-4,-3/-3,-2/-2,-1/-1,1/1,2/2,3/3,4/4}
...
\draw[very thick, ->] (4,1) -- (4,4.85);

% Left edge (open): dashed, extends upward with arrow
\draw[very thick, dashed, ->] (-3,1) -- (-3,4.85);
