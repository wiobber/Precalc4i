...
\begin{tabular}{cc}
% \input{Relations_pic1.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=6]
  \node at (axis cs:-4.25,6){$N$ (inputs)};
  \node at (axis cs:-4.25,5){White Paw};
  \node at (axis cs:-4.25,3){Cooper};
  \node at (axis cs:-4.25,1){Bingo};
  \node at (axis cs:-4.25,-1){Kennie};
  \node at (axis cs:0,6){$f$};
  \node at (axis cs:3.5,6){$T$ (outputs)};
  \node at (axis cs:3.5,5){cat};
  \node at (axis cs:3.5,3){lizard};
  \node at (axis cs:3.5,1){turtle};
  \draw[->, line width=1pt] (axis cs:-2.5,5) -- (axis cs:2.5,5);
  \draw[->, line width=1pt] (axis cs:-2.5,3) -- (axis cs:2.5,5);
  \draw[->, line width=1pt] (axis cs:-2.5,1) -- (axis cs:2.5,3);
  \draw[->, line width=1pt] (axis cs:-2.5,-1) -- (axis cs:2.5,1);
  \node at (rel axis cs:0.5,-0.08){};
\end{axis}
\end{tikzpicture}


&
% \input{Relations_pic2.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=6]
  \node at (axis cs:-3.5,6){$T$ (inputs)};
  \node at (axis cs:-3.5,5){cat};
  \node at (axis cs:-3.5,3){lizard};
  \node at (axis cs:-3.5,1){turtle};
  \node at (axis cs:0,6){$g$};
  \node at (axis cs:3.75,6){$N$ (outputs)};
  \node at (axis cs:3.75,5){White Paw};
  \node at (axis cs:3.75,3){Cooper};
  \node at (axis cs:3.75,1){Bingo};
  \node at (axis cs:3.75,-1){Kennie};
  \draw[->, line width=1pt] (axis cs:-2.5,5) -- (axis cs:2.5,5);
  \draw[->, line width=1pt] (axis cs:-2.5,5) -- (axis cs:2.5,3);
  \draw[->, line width=1pt] (axis cs:-2.5,3) -- (axis cs:2.5,1);
  \draw[->, line width=1pt] (axis cs:-2.5,1) -- (axis cs:2.5,-1);
  \node at (rel axis cs:0.5,-0.08){};
\end{axis}
\end{tikzpicture}
...
% \input{Relations_pic3.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=5]
  \node at (axis cs:-3.25,5){$-1$};
  \node at (axis cs:-3.25,3){$0$};
  \node at (axis cs:-3.25,1){$4$};
  \node at (axis cs:3,5){$-3$};
  \node at (axis cs:3,3){$-2$};
  \node at (axis cs:3,1){$1$};
  \node at (axis cs:3,-1){$3$};
  \addplot[only marks, mark=*, mark size=1.5pt] coordinates {(-2.5,5) (2.5,-1) (-2.5,3) (2.5,5) (-2.5,1) (2.5,3) (2.5,1)};
  \draw[->, line width=1pt] (axis cs:-2.5,5) -- (axis cs:2.5,-1);
  \draw[->, line width=1pt] (axis cs:-2.5,3) -- (axis cs:2.5,5);
  \draw[->, line width=1pt] (axis cs:-2.5,1) -- (axis cs:2.5,3);
  \draw[->, line width=1pt] (axis cs:-2.5,1) -- (axis cs:2.5,1);
  \node at (rel axis cs:0.5,-0.08){A Mapping Diagram of $R$};
\end{axis}
\end{tikzpicture}
...
% \input{Relations_pic4.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=5]
  \addplot[only marks, mark=*, mark size=1.75pt] coordinates {(-1,3) (0,-3) (4,-2) (4,1)};
  \node[flabel, label=above left :{$(-1,3)$}] at (axis cs:-1,3){};
  \node[flabel, label=below right:{$(4,-2)$}]  at (axis cs: 4,-2){};
  \node[flabel, label=above right:{$(4,1)$}]   at (axis cs: 4, 1){};
  \node[flabel, label=below right:{$(0,-3)$}]  at (axis cs: 0,-3){};
...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5]
  \addplot[only marks, mark=*, mark size=1.75pt] coordinates {(0,0) (-3,1) (4,2) (-3,2)};
...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5]
  ...
  \addplot[only marks, mark=*, mark size=1.75pt] coordinates {(-2,3)};
...
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5]
  \addplot[fgraph, domain=-3:4] {1};
  \addplot[fgraph] coordinates {(-3,1) (4,1) (4,5)};
  \addplot[dashed] coordinates {(-3,1) (-3,5)};
  \addplot[only marks, mark=o, mark size=1.75pt] coordinates {(-3,1)};
  \node at (rel axis cs:0.5,-0.08){The graph of $T$};
\end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5]
  \addplot[only marks, mark=*, mark size=1.75pt] coordinates {(-2,0.25) (-1,0.5) (0,1) (1,2) (2,4)};
  \node[flabel, label=above right:{$(-2,\tfrac{1}{4})$}] at (axis cs:-2,0.25){};
  \node[flabel, label=above right:{$(-1,\tfrac{1}{2})$}] at (axis cs:-1,0.5){};
...
% \input{Relations_pic10.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5]
  \addplot[only marks, mark=*, mark size=1.75pt] coordinates {(0,0) (-1,1) (1,1) (-2,4) (2,4)};
  \node[flabel, label=above left :{$(-2,4)$}] at (axis cs:-2,4){};
  \node[flabel, label=above right:{$(2,4)$}]  at (axis cs: 2,4){};
  \node[flabel, label=above left :{$(-1,1)$}] at (axis cs:-1,1){};
  \node[flabel, label=below right:{$(1,1)$}]  at (axis cs: 1,1){};
  \node[flabel, label=above right:{$(0,0)$}]  at (axis cs: 0,0){};
...
% \input{Relations_pic11.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-3, ymax=3]
  \addplot[fgraph, domain=-3:3] ({3},{x});
  \node[flabel, label=above left :{$x=3$}] at (axis cs:3,2.5){};
  \node at (rel axis cs:0.5,-0.08){The graph of $V$};
\end{axis}
\end{tikzpicture}



% \input{Relations_pic12.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5]
  \addplot[fgraph, domain=-5:5] {3};
  \addplot[dashed, domain=-5:5] {1};
  \node[flabel, label=above left :{$y=3$}]   at (axis cs:-4.5,3){};
  \node[flabel, label=above left :{$y=1$}]   at (axis cs:-4.5,1){};
  \node at (rel axis cs:0.5,-0.08){The graph of $R$};
\end{axis}
\end{tikzpicture}
...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-4, ymax=4]
  \addplot[fpplot, domain=-2.5:1, samples=200] ({ sqrt(1 - (t)^3) },{ t });
  \addplot[fpplot, domain=-2.5:1, samples=200] ({-sqrt(1 - (t)^3) },{ t });
  \addplot[only marks, mark=*, mark size=1.5pt] coordinates {(-3,-2) (-2,-1.4422) (-1,0) (0,1) (3,-2) (2,-1.4422) (1,0)};
...
% \input{Relations_pic18.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=5]
  \addplot[fpplot, domain=0:1.5] ({  2*cosh(t) },{  2*sinh(t) });
  \addplot[fpplot, domain=0:1.5] ({ -2*cosh(t) },{  2*sinh(t) });
  \addplot[only marks, mark=*, mark size=1.5pt] coordinates {(-2,0) (2,0) (-3,2.236) (3,2.236) (4,3.464) (-4,3.464)};
  \node at (rel axis cs:0.5,-0.08){$f_{1}(x) = \sqrt{x^2-4}$};
\end{axis}
\end{tikzpicture}


% \input{Relations_pic19.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=5]
  \addplot[fpplot, domain=0:1.5] ({  2*cosh(t) },{ -2*sinh(t) });
  \addplot[fpplot, domain=0:1.5] ({ -2*cosh(t) },{ -2*sinh(t) });
  \addplot[only marks, mark=*, mark size=1.5pt] coordinates {(-2,0) (2,0) (-3,-2.236) (3,-2.236) (4,-3.464) (-4,-3.464)};
  \node at (rel axis cs:0.5,-0.08){$f_{2}(x) = -\sqrt{x^2-4}$};
\end{axis}
\end{tikzpicture}
...
% \input{Relations_pic20.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-3, ymax=3]
  \addplot[fpplot, domain=-2.25:2.25] ({t^3-3*t},{t});
  \addplot[only marks, mark=*, mark size=1.5pt] coordinates {(0,0) (0,-1.732) (0,1.732) (2,-1) (-2,1)};
...
% \input{Relations_pic21.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-3, ymax=3]
  \addplot[fpplot, domain=-2.25:-1] ({t^3-3*t},{t});
  \addplot[fpplot, densely dotted, domain=-1:2.25] ({t^3-3*t},{t});
  \addplot[only marks, mark=*, mark size=1.5pt] coordinates {(0,-1.732) (2,-1)};
  \node[flabel, label=below right:{$(0,-\sqrt{3})$}] at (axis cs:0,-1.732){};
  \node[flabel, label=below right:{$(2,-1)$}]       at (axis cs:2,-1){};
  \node at (rel axis cs:0.5,-0.08){$y = f_{1}(x)$};
\end{axis}
\end{tikzpicture}
...
% \input{Relations_pic22.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-3, ymax=3]
  \addplot[fpplot, domain=-1:1] ({t^3-3*t},{t});
  \addplot[fpplot, densely dotted, domain=1:2.25] ({t^3-3*t},{t});
  \addplot[fpplot, densely dotted, domain=-2.25:-1] ({t^3-3*t},{t});
  \addplot[only marks, mark=*, mark size=1.5pt] coordinates {(0,0) (2,-1) (-2,1)};
  \node[flabel, label=above left :{$(-2,1)$}] at (axis cs:-2,1){};
  \node[flabel, label=below right:{$(2,-1)$}] at (axis cs: 2,-1){};
  \node[flabel, label=above right:{$(0,0)$}]  at (axis cs: 0,0){};
  \node at (rel axis cs:0.5,-0.08){$y = f_{2}(x)$};
\end{axis}
\end{tikzpicture}
...
% \input{Relations_pic23.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-3, ymax=3]
  \addplot[fpplot, domain=1:2.25] ({t^3-3*t},{t});
  \addplot[fpplot, densely dotted, domain=-2.25:1] ({t^3-3*t},{t});
  \addplot[only marks, mark=*, mark size=1.5pt] coordinates {(0,1.732) (-2,1)};
  \node[flabel, label=above left :{$(-2,1)$}]  at (axis cs:-2,1){};
  \node[flabel, label=above right:{$(0,\sqrt{3})$}] at (axis cs:0,1.732){};
  \node at (rel axis cs:0.5,-0.08){$y = f_{3}(x)$};
\end{axis}
\end{tikzpicture}
