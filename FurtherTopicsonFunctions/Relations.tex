...
\begin{image}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=5,x axis line style={-{Latex[length=8pt,width=5pt]}, line width=1.2pt},
            y axis line style={-{Latex[length=8pt,width=5pt]}, line width=1.2pt}]
  \addplot[only marks, mark=*,black, mark size=2pt] coordinates {(-1,3) (0,-3) (4,-2) (4,1)};
...
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5,x axis line style={-{Latex[length=8pt,width=5pt]}, line width=1.2pt},
            y axis line style={-{Latex[length=8pt,width=5pt]}, line width=1.2pt}]
...
\begin{axis}[
    ...
    xmin=-5, xmax=5,
    ymin=-1, ymax=5,
    x axis line style={-{Latex[length=8pt,width=5pt]}, line width=1.2pt},
            y axis line style={-{Latex[length=8pt,width=5pt]}, line width=1.2pt},
    xlabel={$t$},
    ylabel={$s$}
]
...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5,
  ...
  \addplot[only marks, mark=*, mark size=3pt] coordinates {(-2,0.25) (-1,0.5) (0,1) (1,2) (2,4)};
...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5,
  ...
  \addplot[only marks, mark=*, mark size=3pt] coordinates {(0,0) (-1,1) (1,1) (-2,4) (2,4)};
    \node at (rel axis cs:0.5,-0.08){The graph of $S$};
\end{axis}
\end{tikzpicture}
 \end{image}
...
\draw[-,line width=3pt,blue](3,-2.5)--(3,2.5);
 ...
 \node[anchor=north, color=blue] at (2,3) {Graph of $V$};
      \end{axis}
        \end{tikzpicture}
\end{image}
