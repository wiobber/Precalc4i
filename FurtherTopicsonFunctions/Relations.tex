...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5,
  ...
  \addplot[only marks, mark=*, mark size=4pt] coordinates {(-2,0.25) (-1,0.5) (0,1) (1,2) (2,4)};
...
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-1, ymax=5,
  ...
  \addplot[only marks, mark=*, mark size=4pt] coordinates {(0,0) (-1,1) (1,1) (-2,4) (2,4)};
    \node at (rel axis cs:0.5,-0.08){The graph of $S$};
\end{axis}
\end{tikzpicture}
 \end{image}
