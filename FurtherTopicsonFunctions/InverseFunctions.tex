...
% \input{InverseFunctions_pic3.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-4, xmax=4, ymin=-5, ymax=5]
  \addplot[fpplot, domain=0.42:3.58] ({(t - 2)^3 + 1},{t});
  \addplot[only marks, mark=*] coordinates {(0,1) (1,2) (2,3)};
  \node[flabel, label=above right:{$(0,1)$}] at (axis cs:0,1) {};
  \node[flabel, label=above right:{$(1,2)$}] at (axis cs:1,2) {};
...
% \input{InverseFunctions_pic4.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-4, xmax=4, ymin=-5, ymax=5]
  \addplot[fgraph, domain=0.42:3.58] {(x - 2)^3 + 1};
  \addplot[only marks, mark=*] coordinates {(1,0) (2,1) (3,2)};
  \node[flabel, label=below right:{$(1,0)$}] at (axis cs:1,0) {};
  \node[flabel, label=above right:{$(2,1)$}] at (axis cs:2,1) {};
  \node[flabel, label=above right:{$(3,2)$}] at (axis cs:3,2) {};
  \node at (axis description cs:0.5,-0.1) {$y=g(x)$};
\end{axis}
\end{tikzpicture}


% \input{InverseFunctions_pic5.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-4, xmax=4, ymin=-5, ymax=5]
  \addplot[dashed, domain=-3.5:4.5] {x};
  \addplot[fpplot, domain=0.42:3.58] ({(t - 2)^3 + 1},{t});
  \addplot[fgraph,  domain=0.42:3.58] {(x - 2)^3 + 1};
  \addplot[only marks, mark=*] coordinates {(0,1) (1,2) (2,3) (1,0) (2,1) (3,2)};
  ...
  \node[flabel, label=above right:{$(2,1)$}] at (axis cs:2,1) {};
  \node[flabel, label=above right:{$(3,2)$}] at (axis cs:3,2) {};
  \node at (axis description cs:0.5,-0.1) {$y=f(x),\ y=g(x),\ y=x$};
\end{axis}
\end{tikzpicture}
...
% \input{InverseFunctions_pic22.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-3, xmax=3, ymin=-1, ymax=8]
  \addplot[fgraph, domain=-2.75:2.75] {x^2};
  \addplot[only marks, mark=*] coordinates {(-2,4) (2,4) (0,0)};
  \node[flabel, label=above left :{$(-2,4)$}] at (axis cs:-2,4) {};
  \node[flabel, label=above right:{$(2,4)$}]  at (axis cs: 2,4) {};
  \node[flabel, label=below right:{$(0,0)$}]  at (axis cs: 0,0) {};
  \node at (axis description cs:0.5,-0.1) {$y=f(x) = x^2$};
\end{axis}
\end{tikzpicture}
  

% \input{InverseFunctions_pic23.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-3, xmax=3, ymin=-1, ymax=8]
  \addplot[fgraph, domain=0:2.75] {x^2};
  \addplot[only marks, mark=*] coordinates {(2,4) (0,0)};
  \node[flabel, label=above right:{$(2,4)$}]  at (axis cs:2,4) {};
  \node[flabel, label=below right:{$(0,0)$}]  at (axis cs:0,0) {};
  \node at (axis description cs:0.5,-0.1) {$y=f_{1}(x) = x^2,\ x \ge 0$};
\end{axis}
\end{tikzpicture}
  

% \input{InverseFunctions_pic24.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-3, xmax=3, ymin=-1, ymax=8]
  \addplot[fgraph, domain=-2.75:0] {x^2};
  \addplot[only marks, mark=*] coordinates {(-2,4) (0,0)};
  \node[flabel, label=above left :{$(-2,4)$}] at (axis cs:-2,4) {};
  \node[flabel, label=below right:{$(0,0)$}]  at (axis cs: 0,0) {};
  \node at (axis description cs:0.5,-0.1) {$y=f_{2}(x) = x^2,\ x \le 0$};
\end{axis}
\end{tikzpicture}
