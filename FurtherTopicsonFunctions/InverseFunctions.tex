...
%% Main ray: f(x) = |x|, x < 0  (i.e. y = -x for x < 0)
\addplot[smooth, line width=3pt, penColor1, domain=-4:4, samples=200] {(x-2)^3+1};
\addplot[smooth, line width=3pt, penColor1, domain=-4:4, samples=200] {sign(x-1)*abs(x-1)^(1/3)+2};
