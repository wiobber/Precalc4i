...
\addplot[smooth, line width=3pt, blue] {3*x+4};
...
\item  $f(x) = \sqrt[3]{x-1} + 2$ and $g(x) = (x-2)^3+1$ \vphantom{ $f(t) = \frac{3t}{t+1}$ and $g(t) = \frac{t}{3-t}$}
...
%% Main ray: f(x) = |x|, x < 0  (i.e. y = -x for x < 0)
\addplot[smooth, line width=1.5pt, penColor1, domain=-4:4, samples=200] {(x-2)^3+1};
...
%% Main ray: f(x) = |x|, x < 0  (i.e. y = -x for x < 0)
\addplot[smooth, line width=2pt, penColor1, domain=-4:4, samples=200] {(x-2)^3+1};
...
\textit{Solution for  $f(t) = \frac{2t}{t+1}$ and $g(t) = \frac{t}{2-t}$.}
...
&
 ...
 % \input{InverseFunctions_pic12.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-3, xmax=3, ymin=-1, ymax=7]
  \addplot[dashed, domain=-1:3] {4};
  \addplot[fgraph, domain=-1:3] {x^2 - 2*x + 4};
  \addplot[only marks, mark=*] coordinates {(1,3)};
  \node[flabel, label=above right:{$(1,3)$}] at (axis cs:1,3) {};
  \node at (axis description cs:0.5,-0.1) {$y=f(x)$};
\end{axis}
\end{tikzpicture}
 \\
...
% \input{InverseFunctions_pic13.tex}
\begin{tikzpicture}
...
% \input{InverseFunctions_pic14.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-7, ymax=5]
  \addplot[dashed, domain=-5:5] {-2};
  \addplot[dashed] coordinates {(1,-7) (1,5)};
...
% \input{InverseFunctions_pic15.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-7, ymax=5]
  \addplot[dashed, domain=-5:5] {1};
  \addplot[dashed] coordinates {(-2,-7) (-2,5)};
  \addplot[fgraph, domain=-5:-2.5] {x/(x + 2)};
  \addplot[fgraph, domain=-1.66:5] {x/(x + 2)};
  \addplot[only marks, mark=*] coordinates {(0,0)};
  \node[flabel, label=below       :{$t=-2$}] at (axis cs:-2,-6) {};
  \node[flabel, label=above right:{$y=1$}]   at (axis cs:4, 1) {};
  \node[flabel, label=above right:{$(0,0)$}] at (axis cs:0, 0) {};
  \node at (axis description cs:0.5,-0.1) {$y=g^{-1}(t)$};
\end{axis}
\end{tikzpicture}
  \end{array}\]
...
% \input{InverseFunctions_pic16.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=5]
  \addplot[dashed, domain=-5:5] {1};
  \addplot[only marks, mark=*] coordinates {(-1,1) (0,2) (2,1) (1,-3)};
  \node[flabel, label=above left :{$(-1,1)$}] at (axis cs:-1, 1) {};
  \node[flabel, label=above right:{$(0,2)$}]  at (axis cs: 0, 2) {};
  \node[flabel, label=below right:{$(2,1)$}]  at (axis cs: 2, 1) {};
  \node[flabel, label=below right:{$(1,-3)$}] at (axis cs: 1,-3) {};
  \node at (axis description cs:0.5,-0.1) {$y=F(x)$};
\end{axis}
\end{tikzpicture}
...
% \input{InverseFunctions_pic17.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=5]
...
% \input{InverseFunctions_pic18.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=5]
...
% \input{InverseFunctions_pic20.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-1, xmax=8, ymin=-3, ymax=3]
  \addplot[fgraph, domain=0:7.56] {sqrt(x)};
  \addplot[only marks, mark=*] coordinates {(4,2) (0,0)};
  \node[flabel, label=above right:{$(4,2)$}] at (axis cs:4,2) {};
  \node[flabel, label=below right:{$(0,0)$}] at (axis cs:0,0) {};
  \node at (axis description cs:0.5,-0.1) {$y = g_{1}(x) = \sqrt{x}$};
\end{axis}
\end{tikzpicture}


% \input{InverseFunctions_pic21.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-1, xmax=8, ymin=-3, ymax=3]
  \addplot[fgraph, domain=0:7.56] {-sqrt(x)};
  \addplot[only marks, mark=*] coordinates {(4,-2) (0,0)};
  \node[flabel, label=below right:{$(4,-2)$}] at (axis cs:4,-2) {};
  \node[flabel, label=above right:{$(0,0)$}]  at (axis cs:0, 0) {};
  \node at (axis description cs:0.5,-0.1) {$y = g_{2}(x) = -\sqrt{x}$};
\end{axis}
\end{tikzpicture}
...
%% Main ray: f(x) = |x|, x < 0  (i.e. y = -x for x < 0)
\addplot[smooth, line width=1.5pt, penColor1, domain=-4:4, samples=200] {x^2};
\addplot[
  only marks,
  mark=*,
  mark size=2pt,
...
%% Main ray: f(x) = |x|, x < 0  (i.e. y = -x for x < 0)
\addplot[smooth, line width=1.5pt, penColor1, domain=0:4, samples=200] {x^2};
\addplot[
  only marks,
  mark=*,
  mark size=2pt,
...
%% Main ray: f(x) = |x|, x < 0  (i.e. y = -x for x < 0)
\addplot[smooth, line width=1.5pt, penColor1, domain=-4:0, samples=200] {x^2};
\addplot[
  only marks,
  mark=*,
  mark size=2pt,
...
%% Main ray: f(x) = |x|, x < 0  (i.e. y = -x for x < 0)
\addplot[smooth, line width=2pt, penColor1, domain=0:4, samples=200] {x^2};
\addplot[smooth, line width=2pt, penColor1, domain=0:8, samples=200] {x^(0.5)};
...
%% Main ray: f(x) = |x|, x < 0  (i.e. y = -x for x < 0)
\addplot[smooth, line width=2pt, penColor1, domain=-5:0, samples=200] {x^2};
\addplot[smooth, line width=2pt, penColor1, domain=0:5, samples=200] {-x^(0.5)};
...
% \input{InverseFunctions_pic27.tex}
\begin{tikzpicture}
...
% \input{InverseFunctions_pic28.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-1, xmax=7, ymin=-1, ymax=7]
  \addplot[dashed, domain=-1:7] {x};
  \addplot[fgraph, domain=-1:1] {x^2 - 2*x + 4};
  \addplot[fgraph, domain=3:7] {1 - sqrt(x - 3)};
  \addplot[only marks, mark=*] coordinates {(1,3) (3,1)};
  \node[flabel, label=above right:{$(1,3)$}] at (axis cs:1,3) {};
  \node[flabel, label=below right:{$(3,1)$}] at (axis cs:3,1) {};
  \node[flabel, label=above left :{$y=j(x)$}]       at (axis cs:-0.5,4) {};
  \node[flabel, label=below right:{$y=j^{-1}(x)$}]  at (axis cs:4,-0.5) {};
  \node[flabel, label=above right:{$y=x$}]          at (axis cs:5.5,5.5) {};
  \node at (axis description cs:0.5,-0.1) {$j$ and $j^{-1}$};
\end{axis}
\end{tikzpicture}
...
% \input{InverseFunctions_pic29.tex}
\begin{tikzpicture}
...
% \input{InverseFunctions_pic30.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-3, xmax=3, ymin=-3, ymax=3]
  \addplot[dashed, domain=-3:3] {x};
  \addplot[fgraph, domain=-2:3] {sqrt(x + 2) - 1};
  \addplot[fgraph, domain=-1:1.2] {x^2 + 2*x - 1};
  \addplot[only marks, mark=*] coordinates {(-2,-1) (-1,-2)};
  \node[flabel, label=above left :{$(-2,-1)$}] at (axis cs:-2,-1) {};
  \node[flabel, label=below right:{$(-1,-2)$}] at (axis cs:-1,-2) {};
  \node[flabel, label=above left :{$y=k(t)$}]        at (axis cs:-1, 1) {};
  \node[flabel, label=below right:{$y=k^{-1}(t)$}]   at (axis cs: 1,-1) {};
  \node[flabel, label=above right:{$y=x$}]           at (axis cs: 2, 2) {};
  \node at (axis description cs:0.5,-0.1) {$k$ and $k^{-1}$};
\end{axis}
\end{tikzpicture}
