...
% \input{InverseFunctions_pic6.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-4, xmax=5, ymin=-5, ymax=5]
  \addplot[dashed] coordinates {(-1,-5) (-1,5)};
  \addplot[dashed, domain=-4:5] {2};
  \addplot[fgraph, domain=-4:-1.67] {2*x/(x + 1)};
  \addplot[fgraph, domain=-0.71:5]  {2*x/(x + 1)};
  \addplot[only marks, mark=*] coordinates {(0,0)};
  \node[flabel, label=below       :{$t=-1$}] at (axis cs:-1,-4.5) {};
  \node[flabel, label=above right:{$y=2$}]   at (axis cs:4, 2) {};
  \node[flabel, label=below right:{$(0,0)$}] at (axis cs:0, 0) {};
  \node at (axis description cs:0.5,-0.1) {$y=f(t)$};
\end{axis}
\end{tikzpicture}


% \input{InverseFunctions_pic7.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-4, xmax=5, ymin=-5, ymax=5]
  \addplot[dashed] coordinates {(2,-5) (2,5)};
  \addplot[dashed, domain=-4:5] {-1};
  \addplot[fgraph, domain=-4:1.66] {x/(2 - x)};
  \addplot[fgraph, domain=2.5:5]   {x/(2 - x)};
  \addplot[only marks, mark=*] coordinates {(0,0)};
  \node[flabel, label=below       :{$t=2$}]   at (axis cs:2,-4.5) {};
  \node[flabel, label=below left :{$y=-1$}]  at (axis cs:-3,-1) {};
  \node[flabel, label=below right:{$(0,0)$}] at (axis cs: 0, 0) {};
...
% \input{InverseFunctions_pic8.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-4, xmax=5, ymin=-5, ymax=5]
  \addplot[dashed] coordinates {(2,-5) (2,5)};
  \addplot[dashed, domain=-4:5] {-1};
  \addplot[dashed] coordinates {(-1,-5) (-1,5)};
  \addplot[dashed, domain=-4:5] {2};
  \addplot[dashed, domain=-3.5:4.5] {x};
  \addplot[fgraph, domain=-4:1.66] {x/(2 - x)};
  \addplot[fgraph, domain=2.5:5]   {x/(2 - x)};
  \addplot[fgraph, domain=-4:-1.67] {2*x/(x + 1)};
  \addplot[fgraph, domain=-0.71:5]  {2*x/(x + 1)};
  ...
  \node at (axis description cs:0.5,-0.1) {$y=f(t),\ y=g(t),\ y=x$};
\end{axis}
\end{tikzpicture}
...
% \input{InverseFunctions_pic10.tex}
\begin{tikzpicture}
...
% \input{InverseFunctions_pic11.tex}
\begin{tikzpicture}
