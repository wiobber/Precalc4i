...
% \input{InverseFunctions_pic1.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-15, xmax=15, ymin=-10, ymax=10]
  \addplot[dashed, domain=-15:15] {0}; % baseline if needed
  \draw (axis cs:-7.5,0) ellipse [x radius=6, y radius=5];
  \draw (axis cs:7.5,0) ellipse [x radius=6, y radius=5];
  \addplot[fgraph, domain=-7.25:7.25, samples=50] ({x}, {5 - (25/52)*(x)^2}); % simple smooth arc (approx)
  \addplot[fgraph, domain=-7.25:7.25, samples=50, dashed] ({x}, {-5 + (25/52)*(x)^2}); % dashed opposite arc
  \draw[->] (axis cs:-7.25,0.25) .. controls (axis cs:0,5) .. (axis cs:7.25,0.25);
  \draw[->, dashed] (axis cs:7.25,-0.25) .. controls (axis cs:0,-5) .. (axis cs:-7.25,-0.25);
  \addplot[only marks, mark=*] coordinates {(-7.5,0) (7.5,0)};
  \node[flabel, label=above :{$f$}] at (axis cs:0,6) {};
  \node[flabel, label=below :{$g$}] at (axis cs:0,-6) {};
  \node[flabel, label=above :{$x = g(f(x))$}] at (axis cs:-7.5,-2) {};
  \node[flabel, label=above :{$y = f(x)$}]     at (axis cs: 7.5,-2) {};
\end{axis}
\end{tikzpicture}
...
% \input{InverseFunctions_pic2.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-5, xmax=5, ymin=-5, ymax=5]
  \addplot[dashed, domain=-5:5] {x};
  \addplot[fgraph, domain=-3:0.333] {3*x + 4};
  \addplot[fgraph, domain=-5:5] {(x - 4)/3};
  \addplot[only marks, mark=*] coordinates {(0,4) (4,0)};
  \node[flabel, label=above left :{$(0,4)$}] at (axis cs:0,4) {};
  \node[flabel, label=below right:{$(4,0)$}] at (axis cs:4,0) {};
  \node[flabel, label=above left :{$y=f(x)$}] at (axis cs:-2,2) {};
  \node[flabel, label=below right:{$y=g(x)$}] at (axis cs: 2,-1.5) {};
  \node[flabel, label=above right:{$y=x$}]    at (axis cs: 2, 2) {};
  \node at (axis description cs:0.5,-0.1) {$f$ and $g$ are inverses};
\end{axis}
\end{tikzpicture}
...
% \input{InverseFunctions_pic9.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-15, xmax=15, ymin=-10, ymax=10]
  \draw (axis cs:-7.5,0) ellipse [x radius=6, y radius=5];
  \draw (axis cs:7.5,0)  ellipse [x radius=6, y radius=5];
  \addplot[only marks, mark=*] coordinates {(-7.5,2) (-7.5,-2) (7.5,0)};
  \draw[->] (axis cs:-7.5, 2) -- (axis cs:7.25, 0.25);
  \draw[->] (axis cs:-7.5,-2) -- (axis cs:7.25,-0.25);
  \draw[->] (axis cs:-3,4) .. controls (axis cs:0,5) .. (axis cs:3,4);
  \draw[->, dashed] (axis cs:7.25,-0.25) .. controls (axis cs:0,-5) .. (axis cs:-7.25,-2.25);
  \node[flabel, label=above :{$f$}]            at (axis cs:0, 6) {};
  \node[flabel, label=below :{$g$}]            at (axis cs:0,-6) {};
  \node[flabel, label=above :{$x = -2$}]       at (axis cs:-7.5, 1) {};
  \node[flabel, label=below :{$x = 2$}]        at (axis cs:-7.5,-4) {};
  \node[flabel, label=above :{$4$}]            at (axis cs: 7.5,-1) {};
\end{axis}
\end{tikzpicture}
