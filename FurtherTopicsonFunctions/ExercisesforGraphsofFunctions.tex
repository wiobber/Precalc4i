...
\node at (-5,-5) [right=4pt] {$(-5,-5)$};
\node at (-4,0) [above=8pt,left=4pt] {$(-4,0)$};
\node at (-3,4) [above=8pt] {$(-3,4)$};
\node at (-2,2) [above=8pt,right=2pt] {$(-2,2)$};
\node at (2,3) [above=8pt] {$(2,3)$};
\node at (3,1) [right=4pt] {$(3,1)$};
\end{axis}
...
\begin{problem} \label{usefuncgraphfirst}
...
\begin{problem} \label{usefuncgraphlast}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % Axis labels
    \node at (axis cs:5,-0.5) {  $t$};
    \node at (axis cs:0.5,6) {  $y$};

    % Labels near points
    \node at (axis cs:-4,0.5)  {  $(-4,0)$};
    \node at (axis cs:-2,-5.5) {  $(-2,-5)$};
    \node at (axis cs:1,-0.5)  {  $(0,0)$};
    \node at (axis cs:2,2.5)   {  $(2,3)$};
    \node at (axis cs:2,5.5)   {  $(2,5)$};
    \node at (4,0)[above=8pt,right=2pt] {  $(4,0)$};
...
\item %\input{ExercisesforGraphsofFunctions_pic7.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-3, xmax=3, ymin=-2, ymax=5]
  \addplot[fgraph, domain=-2:2] {x^2};
  \addplot[only marks, mark=*] coordinates {(-2,4) (0,-1) (2,4)};
