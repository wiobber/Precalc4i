...
Given a function $f$, the \index{function ! difference quotient}\index{difference quotient}\textbf{difference quotient} of $f$ is the expression \[ \frac{f(x+h) - f(x)}{h} \]
...
\item  $f(x) = x^2-x-2$ \vphantom{$\frac{3}{2x+1}$}

\item  $g(x) = \frac{3}{2x+1}$

\item  $r(x) = \sqrt{x}$ \vphantom{$\frac{3}{2x+1}$}
...
$\frac{f(x+h)-f(x)}{h}$ & = & $\frac{\left(x^2+2xh+h^2-x-h-2 \right)-\left(x^{2}-x-2 \right)}{h}$ & \\[8pt] 
& = & $\frac{x^2+2xh+h^2-x-h-2-x^2+x+2}{h}$ & \\ [8pt]
& = & $\frac{2xh+h^2-h}{h}$ & \\ [8pt]
& = & $\frac{h \left(2x+h-1\right)}{h}$ & factor \\ [8pt]
& = & $\frac{\cancel{h} \left(2x+h-1\right)}{\cancel{h}}$ & cancel \\ [8pt]
& = & $2x+h-1$. \\
...
$\frac{g(x+h)-g(x)}{h}$ & = & $\frac{\frac{3}{2x+2h+1}-\frac{3}{2x+1}}{h}$ & \\ [3pt]
& = &  $\frac{\frac{3}{2x+2h+1}-\frac{3}{2x+1}}{h} \cdot \frac{(2x+2h+1)(2x+1)}{(2x+2h+1)(2x+1)}$ & \\ [3pt]
& = &  $\frac{3(2x+1)-3(2x+2h+1)}{h(2x+2h+1)(2x+1)}$  & \\ [3pt]
& = &  $\frac{6x+3-6x-6h-3}{h(2x+2h+1)(2x+1)}$  & \\ [3pt]
& = &  $\frac{-6h}{h(2x+2h+1)(2x+1)}$  & \\ [3pt]
& = &  $\frac{-6\cancel{h}}{\cancel{h}(2x+2h+1)(2x+1)}$  & \\ [3pt]
& = &  $\frac{-6}{(2x+2h+1)(2x+1)}$.  & \\ 
...
\frac{r(x+h) - r(x)}{h} & = & \frac{\sqrt{x+h} - \sqrt{x}}{h} & \\  
												 ...
												 & = & \frac{\left(\sqrt{x+h} - \sqrt{x}\right)}{h} \cdot \frac{\left(\sqrt{x+h} + \sqrt{x}\right)}{\left(\sqrt{x+h} + \sqrt{x}\right)} & \text{Multiply by the conjugate.} \\  
										
												 & = &  \frac{\left(\sqrt{x+h}\right)^2 - \left(\sqrt{x}\right)^2}{h\left(\sqrt{x+h} + \sqrt{x}\right)} & \text{Difference of Squares.}\\  
												
												& = &  \frac{(x+h) - x}{h\left(\sqrt{x+h} + \sqrt{x}\right)} & \\  
												
												 & = &  \frac{h}{h\left(\sqrt{x+h} + \sqrt{x}\right)} & \\  
												 
												 												 & = &  \frac{\cancelto{1}{h}}{\cancel{h}\left(\sqrt{x+h} + \sqrt{x}\right)} & \\  
