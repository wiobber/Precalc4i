...
\Delta\left[ \frac{u}{v}  \right]& = & \frac{u_{2}}{v_{2}} - \frac{u_{1}}{v_{1}}   \\[10pt]
                       & = &   \frac{ u_{1} + \Delta u}{ v_{1} + \Delta v} - \frac{u_{1}}{v_{1}}  \\[10pt]
                       & = &   \frac{(u_{1} + \Delta u) \, v_{1}}{(v_{1} + \Delta v) \, v_{1}} - \frac{u_{1} \, (v_{1} + \Delta v)}{v_{1} \,   (v_{1} + \Delta v) }\\[10pt]   
                            & = &   \frac{u_{1} \, v_{1}  + v_{1} \, \Delta u- u_{1} \, v_{1} - u_{1} \, \Delta v}{v_{1} \,  (v_{1} + \Delta v)}\\[10pt]   
...
\item  \textbf{The Quotient Rule for Change:}  $\ds{ \Delta\left[ \frac{u}{v} \right] =  \frac{ v_{1} \, \Delta u  - u_{1}  \, \Delta v}{v_{1} \,  (v_{1}  + \Delta v_{1})}}$
