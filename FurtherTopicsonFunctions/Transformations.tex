...
% \input{Transformations_pic10.tex}
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-3, xmax=6, ymin=-1, ymax=6]
  \addplot[fgraph, domain=-2:4] {(x+2)*(6-x)/4};
  \addplot[only marks, mark=*, mark size=1.75pt] coordinates {(-2,0) (0,3) (2,4)};
  \addplot[only marks, mark=o,  mark size=1.75pt] coordinates {(4,3)};
  \node[flabel, label=below left :{$(-2,0)$}] at (axis cs:-2,0){};
  \node[flabel, label=above right:{$(0,3)$}]  at (axis cs: 0,3){};
  \node[flabel, label=above right:{$(2,4)$}]  at (axis cs: 2,4){};
  \node[flabel, label=below right:{$(4,3)$}]  at (axis cs: 4,3){};
  \node at (rel axis cs:0.5,-0.08){$y = f(x)$};
\end{axis}
\end{tikzpicture}
...
% \input{Transformations_pic11.tex}
...
% \input{Transformations_pic12.tex}
...
% \input{Transformations_pic13.tex}
\begin{mfpic}[15]{-4}{6}{-1}{5}
\axes
\tlabel[cc](6,-0.5){\scriptsize $x$}
\tlabel[cc](0.5,5){\scriptsize $y$}
...
% \input{Transformations_pic14.tex}
...
% \input{Transformations_pic15.tex}
\begin{mfpic}[15]{-4}{6}{-3}{5}
\axes
\tlabel[cc](6,-0.5){\scriptsize $x$}
\tlabel[cc](0.5,5){\scriptsize $y$}
