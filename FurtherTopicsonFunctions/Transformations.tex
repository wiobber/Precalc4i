...
\begin{tikzpicture}
\begin{axis}[fplot, xmin=-1, xmax=6, ymin=-1, ymax=6]
  \addplot[fgraph] coordinates {(0,1) (2,3) (4,3) (5,5)};
  \addplot[only marks, mark=*, mark size=1.75pt] coordinates {(0,1) (2,3) (4,3) (5,5)};
  ...
  \node[flabel, label=above right:{$(5,5)$}] at (axis cs:5,5){};
...
% \input{Transformations_pic2.tex}
...
% \input{Transformations_pic3.tex}
\begin{mfpic}[15]{-1}{6}{-1}{8}
