...
% \input{Transformations_pic1.tex}
\begin{image}
...
%% lines
\draw[blue, line width=3.5pt] (0,1)--(2,3);
\draw[blue, line width=3.5pt] (4,3)--(2,3);
\draw[blue, line width=3.5pt] (4,3)--(5,5);
...
\xmalt{Graph of a piecewise linear function passing through the points $(0,1)$, $(2,3)$, $(4,3)$, and $(5,5)$. The graph rises from $(0,1)$ to $(2,3)$, remains horizontal from $(2,3)$ to $(4,3)$, then rises again to $(5,5)$.} 
\end{center}
        ...
        \begin{axis}[
          ...
          xtick={1, 2,3,4,5},
           ...
           ytick={2,3, 4, 5},
            ...
            axis x line=center,
            axis y line=center,
            x axis line style={-{Latex[length=5pt,width=4pt]}, line width=0.8pt},
            y axis line style={-{Latex[length=5pt,width=4pt]}, line width=0.8pt},
            xlabel={$x$},
            ylabel={$y$},
           every axis x label/.style={
    at={(current axis.right of origin)},
...
%% lines
\draw[blue, line width=1.5pt] (0,1)--(2,3);
\draw[blue, line width=1.5pt] (4,3)--(2,3);
\draw[blue, line width=1.5pt] (4,3)--(5,5);
...
\node[anchor=south] at (0,0.5) {Shift up $2$ units};
\node[anchor=north] at (0,-0.5) {add $2$};
\node[anchor=north] at (0,-1.5) {to each $y$-coordinate};
...
%% lines
\draw[blue, line width=1.5pt] (0,3)--(2,5);
\draw[blue, line width=1.5pt] (4,5)--(2,5);
\draw[blue, line width=1.5pt] (4,5)--(5,7);
...
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ (left) and $y=g(x)=f(x)+2$ (right).}
\xmalt{Two graphs illustrate a vertical shift. The graph on the left passes through the points $(0,1)$, $(2,3)$, $(4,3)$, and $(5,5)$. The graph on the right passes through the points $(0,3)$, $(2,5)$, $(4,5)$, and $(5,7)$. An arrow indicates that the graph is shifted up $2$ units by adding $2$ to each $y$-coordinate.} 
\end{center}
...
\node[anchor=south] at (0,0.5) {Shift left $2$ units};
\node[anchor=north] at (0,-0.5) {subtract $2$ from};
\node[anchor=north] at (0,-1.5) {each $x$-coordinate};
...
%% lines
\draw[blue, line width=1.5pt] (-2,1)--(0,3);
\draw[blue, line width=1.5pt] (0,3)--(2,3);
\draw[blue, line width=1.5pt] (2,3)--(3,5);
...
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ (left) and $y=g(x)=f(x+2)$ (right).}
\xmalt{Two graphs illustrate a horizontal shift. The graph on the left passes through the points $(0,1)$, $(2,3)$, $(4,3)$, and $(5,5)$. The graph on the right passes through $(-2,1)$, $(0,3)$, $(2,3)$, and $(3,5)$. An arrow indicates that the graph is shifted left $2$ units by subtracting $2$ from each $x$-coordinate.} 
\end{center}
...
\smallskip
 ...
 \item Find a formula for a function $g(t)$ whose graph is the same as the graph of $f$ but shifted to the right $4$ units.
 
 \item Find a formula for a function $h(t)$ whose graph is the same as the graph of $f$ but shifted down $2$ units.
 
 \end{enumerate}
 
 \item Predict how the graph of $F(x) = \dfrac{(x-2)^{\frac{2}{3}}}{x}$ relates to the graph of $f(x) = \dfrac{x^{\frac{2}{3}}}{x+2}$. 
 
\item  Below is the graph of $y = f(x)$.  
...
\addplot[smooth,domain=-2:4, line width=1.5pt, blue] {-0.25*x^2+x+3};
\addplot[
  only marks,
  mark=*,
  mark size=2pt,
...
coordinates {
  (2,4) [$(2,4)$]
      ...
      \end{axis}
        ...
        \end{image}
\begin{center}
    \captionof{figure}{Graph of $y=f(x)$.}
\xmalt{The graph is a downward-opening parabola segment with a closed endpoint at $(-2,0)$, passing through $(0,3)$ and reaching a maximum at $(2,4)$. The graph ends with an open endpoint at $(4,3)$.} 
\end{center}
Use it to sketch the graph of
 ...
 \item  Below on the left is the graph of $y=f(x)$ and below on the right is the graph of $y = g(x)$.  Write $g(x)$ in terms of $f(x)$ and vice-versa.
...
\addplot[smooth,domain=-2:4.5, line width=1.5pt, blue] {-0.25*x^2+1.25*x+1.4375};
\addplot[
  only marks,
  mark=*,
  mark size=2pt,
...
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ (left) and $y=g(x)$ (right).}
\xmalt{The graph on the left is a downward-opening parabola segment with a closed endpoint at $(-2,0)$, passing through $(0,3)$ and reaching a maximum at $(2,4)$. The graph ends with an open endpoint at $(4,3)$. The graph on the right is a downward-opening parabola segment with a closed endpoint at $(-1.5,-1)$, passing through $(0.5,2)$ and reaching a maximum at $(2.5,3)$. The graph ends with an open endpoint at $(4.5,2)$.} 
\end{center}
 ...
 \item  Per Theorem \ref{hshifts}, the graph of $g(t) = f(t-4) = |t-4|-2(t-4) = |t-4|-2t+8$ should be the graph of $f(t) = |t|-2t$ shifted to the right $4$ units.
  
 \item Per Theorem \ref{vshifts},  the graph of $h(t) = f(t)+(-2) = |t|-2t+(-2) = |t|-2t-2$ should be the graph of  $f(t) = |t|-2t$ shifted down $2$ units. 
...
%https://www.desmos.com/calculator/xrmcgegn3j

\begin{center}
\desmos{xrmcgegn3j}{800}{600}
\end{center}

\item  Comparing \textit{formulas}, it appears as if $F(x) = f(x-2)$.  We check: \[ f(x-2) = \dfrac{(x-2)^{\frac{2}{3}}}{(x-2)+2} = \dfrac{(x-2)^{\frac{2}{3}}}{x} = F(x),\]  so, per Theorem \ref{hshifts},  the graph of $y = F(x)$ should be the graph of $y=f(x)$ but shifted to the right $2$ units. Once again, we can use a slider in the Desmos interactive below to visualize this horizontal shift by adjusting the parameter `$a$' from $0$ to $2$ to graph the transformed function $F(x) = f(x-a)$.

% https://www.desmos.com/calculator/yc4sxelkkp
\begin{center}
\desmos{yc4sxelkkp}{800}{600}
\end{center}
...
\addplot[
 ...
 \node[anchor=south] at (0,0.5) {Shift right $2$ units};
 \node[anchor=north] at (0,-0.5) {add $2$ to};
 \node[anchor=north] at (0,-1.5) {each $x$-coordinate};
 ...
 \addplot[smooth,domain=0:6, line width=1.5pt, blue] {-0.25*x^2+2*x};
 \addplot[
   only marks,
   mark=*,
   mark size=2pt,
...
\end{image} 
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ (left) and $y=F(x)=f(x-2)$ (right).}
\xmalt{The graph on the left is a downward-opening parabola segment with closed endpoint $(-2,0)$, vertex $(2,4)$, and open endpoint $(4,3)$. The graph on the right has the same shape and is obtained by shifting the first graph $0.5$ unit to the right and $1$ unit downward. The corresponding points are $(-1.5,-1)$, $(2.5,3)$, and $(4.5,2)$.} 
\end{center}
...
\addplot[
 ...
 \node[anchor=south] at (0,0.5) {Shift up $1$ unit};
 \node[anchor=north] at (0,-0.5) {add $1$ to};
 \node[anchor=north] at (0,-1.5) {each $y$-coordinate};
 ...
 \addplot[smooth,domain=-2:4, line width=1.5pt, blue] {-0.25*x^2+x+4};
 \addplot[
   only marks,
   mark=*,
   mark size=2pt,
...
\end{image} 
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ (left) and $y=F(x)=f(x)+1$ (right).}
\xmalt{Two graphs illustrate a vertical shift. The graph on the left is a downward-opening parabola segment with closed endpoint $(-2,0)$, vertex $(2,4)$, and open endpoint $(4,3)$. The graph on the right has the same shape and is obtained by shifting the first graph upward $1$ unit. The corresponding points are $(-2,1)$, $(2,5)$, and $(4,4)$.} 
\end{center}
...
\addplot[
 ...
 \node[anchor=south] at (0,0.5) {Shift left $1$ unit};
 \node[anchor=north] at (0,-0.5) {subtract $1$ from};
 \node[anchor=north] at (0,-1.5) {each $x$-coordinate};
...
\begin{tikzpicture}[scale=1]font=\small
 ...
 \addplot[smooth,domain=-3:3, line width=1.5pt, blue] {-0.25*x^2+0.5*x+3.75};
 \addplot[
   only marks,
   mark=*,
   mark size=2pt,
...
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ (left) and $y=f(x+1)$ (right).}
\xmalt{Two graphs illustrate a horizontal shift. The graph on the left is a downward-opening parabola segment with closed endpoint $(-2,0)$, vertex $(2,4)$, and open endpoint $(4,3)$. The graph on the right has the same shape and is obtained by shifting the first graph left $1$ unit. The corresponding points are $(-3,0)$, $(1,4)$, and $(3,3)$.} 
\end{center}
...
\begin{tikzpicture}[scale=1]font=\small
 ...
 \node[anchor=south] at (0,0.5) {Shift down $2$ unit};
 \node[anchor=north] at (0,-0.5) {subtract $2$ from};
 \node[anchor=north] at (0,-1.5) {each $y$-coordinate};
...
\begin{tikzpicture}[scale=1]font=\small
 ...
 \addplot[smooth,domain=-3:3, line width=1.5pt, blue] {-0.25*x^2+0.5*x+1.75};
 \addplot[
   only marks,
   mark=*,
   mark size=2pt,
...
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x+1)$ (left) and $y=f(x+1)-2$ (right).}
\xmalt{Two graphs illustrate a vertical shift. The graph on the left is a downward-opening parabola segment with closed endpoint $(-3,0)$, vertex $(1,4)$, and open endpoint $(3,3)$. The graph on the right has the same shape and is obtained by shifting the first graph downward $2$ units. The corresponding points are $(-3,-2)$, $(1,2)$, and $(3,1)$.} 
\end{center}
...
\begin{tikzpicture}[scale=1]
        \begin{axis}[
          ...
          xtick={1, 2,3,4,5},
            xticklabels={$1$,$2$,$3$, $4$, $5$},
           ytick={-5,-4,-3,-2,-1,2,3, 4, 5},
            yticklabels={$-5$,$-4$,$-3$,$-2$,$-1$, $2$,$3$,$4$, $5$},  
            tick style={line width=1.2pt},
            major tick length=6pt,
            axis x line=center,
            axis y line=center,
...
\node[anchor=south] at (0,0.5) {reflect across $x$-axis};
\node[anchor=north] at (0,-0.5) {multiply each};
\node[anchor=north] at (0,-1.5) {$y$-coordinate by $-1$};
...
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ (left) and $y=-f(x)$ (right).}
\xmalt{Two graphs illustrate a reflection across the $x$-axis. The graph on the left is a piecewise linear function passing through the points $(0,1)$, $(2,3)$, $(4,3)$, and $(5,5)$. The graph on the right is obtained by reflecting the first graph across the $x$-axis. The corresponding points are $(0,-1)$, $(2,-3)$, $(4,-3)$, and $(5,-5)$.} 
\end{center}
...
\node[anchor=south] at (0,0.5) {reflect across $y$-axis};
\node[anchor=north] at (0,-0.5) {multiply each};
\node[anchor=north] at (0,-1.5) {$x$-coordinate by $-1$};
...
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ (left) and $y=f(-x)$ (right).}
\xmalt{Two graphs illustrate a reflection across the $y$-axis. The graph on the left is a piecewise linear function passing through the points $(0,1)$, $(2,3)$, $(4,3)$, and $(5,5)$. The graph on the right is obtained by reflecting the first graph across the $y$-axis. The corresponding points are $(0,1)$, $(-2,3)$, $(-4,3)$, and $(-5,5)$.} 
\end{center}
...
Use Theorems  \ref{vshifts},  \ref{hshifts} and \ref{reflections}  to answer the questions below.  Check your answers using a graphing utility where appropriate.
 ...
 \item  \label{twotransxrefex} $y = f(8-x)$
...
\item  Below is the graph of $y = f(x)$.  Use it to sketch the graph of
 \begin{enumerate}
...
\addplot[smooth,domain=-2.5:2.3, line width=1.5pt, blue] {2^x};
...
coordinates {
  ...
  \node[anchor=east, color=blue] at (-0.8,1) {$y=f(x)$};
      \end{axis}
        \end{tikzpicture}
\end{image}
\begin{center}
    \captionof{figure}{Graph of $y=f(x)$}
\xmalt{Graph of an increasing function. The curve rises gradually at first and then becomes steeper as it moves from left to right. The points $(0,1)$, $(1,2)$, and $(2,4)$ are marked and labeled on the graph.} 
\end{center}
...
\addplot[smooth,domain=-3.1:1.9, line width=1.5pt, blue] {-2^(x+1)+4};
\draw[-,dashed, line width=1pt, gray] (-4,4)--(5.5,4);
...
coordinates {
   ...
   \node[anchor=west, color=blue] at (2,-1) {$y=g(x)$};
      \end{axis}
        \end{tikzpicture}
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ and $y=g(x)$}
\xmalt{The graph on the left shows a function passing through the points $(0,1)$, $(1,2)$, and $(2,4)$. The curve increases from left to right, rising gradually at first and then becoming steeper.
...
\end{center}
 ...
 \smallskip
  ...
  \item  In this example, the independent variable is $s$ and the dependent variable is $t$.   We are asked to reflect the graph of $h$ about the $t$-axis, which in this case is the \textit{vertical} axis.  Hence,  $H(s) = h(-s) = (-s)^3-(-s)^2 = -s^3-s^2$. 
  ...
  % https://www.desmos.com/calculator/96sn2hkp5g

  \begin{center}
      \desmos{96sn2hkp5g}{800}{600}
  \end{center}
...
% https://www.desmos.com/calculator/lwjz5zvtva
\begin{center}
\desmos{lwjz5zvtva}{800}{600}
\end{center}
...
\addplot[smooth,domain=-2.5:3, line width=1.5pt, blue] {2^(-x)};
...
coordinates {
  ...
  \node[anchor=west, color=blue] at (0.8,1) {$y=f(-x)$};
      \end{axis}
        \end{tikzpicture}
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ and $y=f(-x)$}
\xmalt{Two graphs illustrate a reflection across the $y$-axis. The graph on the left shows a function passing through the points $(0,1)$, $(1,2)$, and $(2,4)$. The graph on the right is obtained by reflecting the first graph across the $y$-axis and passes through the points $(0,1)$, $(-1,2)$, and $(-2,4)$.} 
\end{center}
...
\node[anchor=south] at (0,0.5) {shift up $1$ unit};
\node[anchor=north] at (0,-0.5) {add $1$ to each};
\node[anchor=north] at (0,-1.5) {$y$-coordinate};
...
\addplot[smooth,domain=-2.5:3, line width=1.5pt, blue] {2^(-x)+1};
\draw[-,dashed, line width=1pt, gray] (-3,1)--(3,1);
...
coordinates {
  ...
  \node[anchor=west, color=blue] at (0,0.5) {$y=f(-x)+1$};
      \end{axis}
        \end{tikzpicture}

\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ and $y=f(x)+1$}
\xmalt{A decreasing function passing through the points $(0,1)$, $(-1,2)$, and $(-2,4)$ is translated upward $1$ unit. The translated graph passes through the points $(0,2)$, $(-1,3)$, and $(-2,5)$. A dashed horizontal line at $y=1$ is shown to indicate the new horizontal asymptote.} 
\end{center}
...
\node[anchor=south] at (0,0.5) {shift left $2$ units};
\node[anchor=north] at (0,-0.5) {subtract $2$ from each};
\node[anchor=north] at (0,-1.5) {$x$-coordinate};
...
\addplot[smooth,domain=-4:1, line width=1.5pt, blue] {2^(x+2)};
...
coordinates {
  ...
  \node[anchor=west, color=blue] at (0,4) {$y=f(x+2)$};
      \end{axis}
        \end{tikzpicture}
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ and $y=f(x+2)$}
\xmalt{An increasing function passing through the points $(0,1)$, $(1,2)$, and $(2,4)$ is translated left $2$ units. The translated graph passes through the points $(-2,1)$, $(-1,2)$, and $(0,4)$.} 
\end{center}
...
\node[anchor=south] at (0,0.5) {reflect about the $y$-axis};
\node[anchor=north] at (0,-0.5) {multiply each };
\node[anchor=north] at (0,-1.5) {$x$-coordinate by $-1$};
...
\addplot[smooth,domain=-1:4, line width=1.5pt, blue] {2^(-x+2)};
...
coordinates {
  ...
  \node[anchor=east, color=blue, font=\tiny] at (-0.1,3.5) {$y=f(-x+2)$};
      \end{axis}
        \end{tikzpicture}
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x+2)$ and $y=f(-x+2)$}
\xmalt{An increasing function passing through the points $(-2,1)$, $(-1,2)$, and $(0,4)$ is reflected across the $y$-axis. The reflected graph passes through the points $(2,1)$, $(1,2)$, and $(0,4)$.} 
\end{center}
...
\node[anchor=south] at (0,0.5) {reflect about the $x$-axis};
\node[anchor=north] at (0,-0.5) {multiply each };
\node[anchor=north] at (0,-1.5) {$y$-coordinate by $-1$};
...
\begin{center}
    \captionof{figure}{Graphs of $y=f(-x+2)$ and $y=-f(-x+2)$}
\xmalt{A decreasing function passing through the points $(0,4)$, $(1,2)$, and $(2,1)$ is reflected across the $x$-axis. The reflected graph passes through the points $(0,-4)$, $(1,-2)$, and $(2,-1)$.} 
\end{center}
...
\addplot[smooth,domain=-1:4, line width=1.5pt, blue] {-2^(-x+2)+1};
\draw[-,dashed, line width=1pt, gray] (-4,1)--(4.5,1);
...
coordinates {
  ...
  \node[anchor=east, color=blue, font=\tiny] at (-0.1,-3.5) {$y=-f(-x+2)+1$};
      \end{axis}
        \end{tikzpicture}
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=-f(-x+2)$ and $y=-f(-x+2)+1$}
\xmalt{A function passing through the points $(0,-4)$, $(1,-2)$, and $(2,-1)$ is translated upward $1$ unit. The translated graph passes through the points $(0,-3)$, $(1,-1)$, and $(2,0)$. A dashed horizontal line is shown above the graph to indicate the new horizontal asymptote.} 
\end{center}
...
\node[anchor=south] at (0,1.5) {vertical scaling};
\node[anchor=south] at (0,0.5) {by a factor of $2$};
\node[anchor=north] at (0,-0.5) {multiply each};
\node[anchor=north] at (0,-1.5) {$y$-coordinate by $2$};
...
\begin{tikzpicture}[scale=1]
        \begin{axis}[
          ...
          xtick={1, 2,3,4,5},
            xticklabels={$1$,$2$,$3$, $4$, $5$},
           ytick={1,3, 4, 5, 6,7,8,9,10},
            yticklabels={$1$,$3$,$4$, $5$,$6$,$7$,$8$,$9$,$10$},   
            tick style={line width=1.2pt},
            major tick length=6pt,
            axis x line=center,
            axis y line=center,
...
%% lines
\draw[blue, line width=1.5pt] (0,2)--(2,6);
\draw[blue, line width=1.5pt] (4,6)--(2,6);
\draw[blue, line width=1.5pt] (4,6)--(5,10);
...
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ and $y=2f(x)$}
\xmalt{A piecewise linear function passing through the points $(0,1)$, $(2,3)$, $(4,3)$, and $(5,5)$ is vertically stretched by a factor of $2$. The transformed graph passes through the points $(0,2)$, $(2,6)$, $(4,6)$, and $(5,10)$.} 
\end{center}
...
\node[anchor=south] at (0,1.5) {vertical scaling};
\node[anchor=south] at (0,0.5) {by a factor of $1/2$};
\node[anchor=north] at (0,-0.5) {multiply each};
\node[anchor=north] at (0,-1.5) {$y$-coordinate by $1/2$};
...
%% lines
\draw[blue, line width=1.5pt] (0,0.5)--(2,1.5);
\draw[blue, line width=1.5pt] (4,1.5)--(2,1.5);
\draw[blue, line width=1.5pt] (4,1.5)--(5,2.5);
...
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ and $y=\frac{1}{2}f(x)$}
\xmalt{A piecewise linear function passing through the points $(0,1)$, $(2,3)$, $(4,3)$, and $(5,5)$ is vertically compressed by a factor of $\frac{1}{2}$. The transformed graph passes through the points $\left(0,\frac{1}{2}\right)$, $\left(2,\frac{3}{2}\right)$, $\left(4,\frac{3}{2}\right)$, and $\left(5,\frac{5}{2}\right)$.} 
\end{center}
...
\frac{5}{2}  & 5 & g\left(\frac{5}{2}\right)=f\left(2 \cdot \frac{5}{2} \right) = f(5) = 5  & \left(\frac{5}{2},5\right) \\   \hline
...
\node[anchor=south] at (0,1.5) {horizontal scaling};
\node[anchor=south] at (0,0.5) {by a factor of $1/2$};
\node[anchor=north] at (0,-0.5) {multiply each};
\node[anchor=north] at (0,-1.5) {$x$-coordinate by $1/2$};
...
%% lines
\draw[blue, line width=1.5pt] (0,1)--(1,3);
\draw[blue, line width=1.5pt] (1,3)--(2,3);
\draw[blue, line width=1.5pt] (2.5,5)--(2,3);
...
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ and $y=f(2x)$}
\xmalt{A piecewise linear function passing through the points $(0,1)$, $(2,3)$, $(4,3)$, and $(5,5)$ is horizontally scaled by a factor of $\frac{1}{2}$. The transformed graph passes through the points $(0,1)$, $(1,3)$, $(2,3)$, and $\left(\frac{5}{2},5\right)$.} 
\end{center}
...
\node[anchor=south] at (0,0.5) {by a factor of $2$};
\node[anchor=north] at (0,-0.5) {multiply each};
\node[anchor=north] at (0,-1.5) {$x$-coordinate by $2$};
...
%% lines
\draw[blue, line width=1.5pt] (0,1)--(4,3);
\draw[blue, line width=1.5pt] (4,3)--(8,3);
\draw[blue, line width=1.5pt] (10,5)--(8,3);
...
\end{image}
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ and $y=f(\frac{1}{2}x)$}
\xmalt{A piecewise linear function passing through the points $(0,1)$, $(2,3)$, $(4,3)$, and $(5,5)$ is horizontally scaled by a factor of $2$. The transformed graph passes through the points $(0,1)$, $(4,3)$, $(8,3)$, and $(10,5)$.} 
\end{center}
...
\item  Below is the graph of $y = f(x)$.  Use it to sketch the graph of
 ...
 \item $F(x) = \frac{1-f(x)}{2}$
 
  \item  $F(x)= f\left( \frac{1-x}{2} \right)$
 
 \end{enumerate}
 
 % https://www.geogebra.org/classic/whqkfda2

 \begin{center}
     \geogebra{whqkfda2}{800}{400}
 \end{center}

 
 \item \label{gfromfrefex} Below on the right is the graph of $y = g(x)$.  Write $g(x)$ in terms of $f(x)$ and vice-versa.
 
% https://www.geogebra.org/classic/zwprjjme

\begin{center}
    \geogebra{zwprjjme}{800}{600}
\end{center}
...
\smallskip
 ...
 \item  To vertically stretch the graph of $y=g(t)$ by $4$, we use Theorem \ref{vscalings} with $a=4$ to get \[G(t) = 4 g(t) = 4 \dfrac{2t+1}{t-1} = \dfrac{4(2t+1)}{t-1} = \dfrac{8t+4}{t-1}.\] 

Using the Desmos interactive below, adjusting the slider for $t$ traces corresponding points on both $y = g(t)$ and
$y = G(t)$.  Dividing the $y$-coordinates on the graph of $y = G(t)$ by the $y$-coordinates of the corresponding points on the graph of $y=g(t)$ confirms a vertical scaling factor of $4$.

% https://www.desmos.com/calculator/f9psccysng

\begin{center}
    \desmos{f9psccysng}{800}{600}
\end{center}
 ...
 % https://www.desmos.com/calculator/fcwljnbnpq  desmos

 \begin{center}
     \desmos{fcwljnbnpq}{800}{600} 
 \end{center}
...
In the Desmos interactive below, the graph of $y=f(x)$ is given as well as the option to click on each intermediary step, in sequence, to build up to the graph of $y=F(x)$.  
 ...
 % https://www.desmos.com/calculator/hiumui8k8l

 \begin{center}
     \desmos{hiumui8k8l}{800}{600}
 \end{center}
...
% https://www.desmos.com/calculator/ycijrcos2v

\begin{center}
    \desmos{ycijrcos2v}{800}{600}
\end{center}
...
% https://www.desmos.com/calculator/5qhn69ljco

\begin{center}
    \desmos{5qhn69ljco}{800}{600}
\end{center}
...
%% lines
\addplot[thick, domain=-4:4, samples=200, line width=1.5pt, blue] {3*cos(deg(pi*x/4))};
%% Regular points, labeled
\addplot[
  only marks,
  mark=*,
...
\begin{center}
    \captionof{figure}{Graph of $y=f(x)$}
\xmalt{Graph of a smooth curve passing through the points $(-4,-3)$, $(-2,0)$, $(0,3)$, $(2,0)$, and $(4,-3)$. The curve rises from left to right, reaches a maximum at $(0,3)$, and then decreases symmetrically back to $(4,-3)$.} 
\end{center}
...
(-4,-3) & -4 & -2x+1 = -4 & x = \frac{5}{2} \\   \hline
(-2,0) &  -2 &  -2x+1 = -2 & x = \frac{3}{2} \\    \hline
(0,3) & 0  & -2x+1 = 0 &  x = \frac{1}{2} \\   \hline
(2,0)  & 2 & -2x+1 = 2  &  x = -\frac{1}{2} \\  \hline
(4,-3) & 4 & -2x+1 = 4  & x = -\frac{3}{2}  \\   \hline
...
% https://www.geogebra.org/classic/vbjxnkwt

\begin{center}
    \geogebra{vbjxnkwt}{800}{600}
\end{center}
...
%https://www.desmos.com/calculator/7pyzjopxda
\begin{center}
\desmos{7pyzjopxda}{800}{600}
\end{center} 
...
%% lines
\draw[blue, line width=1.5pt] (0,-5)--(2,0);
\draw[blue, line width=1.5pt] (2,0)--(4,3);
\draw[blue, line width=1.5pt] (4,3)--(5,3);
...
\begin{center}
    \captionof{figure}{Graphs of $y=f(x)$ and $y=g(x)$}
\xmalt{The graph on the left is a piecewise linear function connecting the points $(0,-5)$, $(2,0)$, $(4,3)$, and $(5,3)$. The graph rises from left to right and then remains horizontal from $(4,3)$ to $(5,3)$.
...
%   // Capture container reference immediately, while currentScript is valid
...
%   // Capture ctx immediately
%   var ctx = canvas.getContext('2d');
 
%   var cx = 250, cy = 220, scale = 60;
...
%     label.textContent =
%       'a = ' + a.toFixed(2) +
%       '   |   point: (' + a.toFixed(2) + ', ' + fa.toFixed(2) + ')' +
...
%       var y = x * x;
%       x <= -3.99 ? ctx.moveTo(px(x), py(y)) : ctx.lineTo(px(x), py(y));
%     }
%     ctx.stroke();
...
%     ctx.lineWidth = 1.5;
%     ctx.beginPath();
%     ctx.moveTo(px(-4), py(slope * (-4 - a) + fa));
%     ctx.lineTo(px( 4), py(slope * ( 4 - a) + fa));
%     ctx.stroke();
 
%     // Point (a, f(a))
%     ctx.beginPath();
%     ctx.arc(px(a), py(fa), 5, 0, Math.PI * 2);
%     ctx.fillStyle = 'red';
%     ctx.fill();
%   }
