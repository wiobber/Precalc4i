...
\begin{observation}
The $x$-axis, $y=0$, is a horizontal asymptote to the graph of $y = f(x)$ and the line $y=4$ is a horizontal asymptote to the graph of $y = g(x)$. 
\end{observation}
...
% \input{Transformations_pic22.tex}
...
% \input{Transformations_pic23.tex}
\begin{mfpic}[15]{-3}{3}{-1}{6}
\axes
\tlabel[cc](3,-0.5){\scriptsize $x$}
\tlabel[cc](0.5,6){\scriptsize $y$}
...
% \input{Transformations_pic24.tex}
\begin{mfpic}[15]{-3}{3}{-1}{6}
\axes
\tlabel[cc](3,-0.5){\scriptsize $x$}
\tlabel[cc](0.5,6){\scriptsize $y$}
...
% \input{Transformations_pic25.tex}
\begin{mfpic}[15]{-3}{3}{-1}{6}
\axes
\tlabel[cc](3,-0.5){\scriptsize $x$}
\tlabel[cc](0.5,6){\scriptsize $y$}
