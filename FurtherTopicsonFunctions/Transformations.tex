...
\node[anchor=south] at (0,1.5) {Shift up $2$ units};
\node[anchor=south] at (0,0.5) {add $2$ to each $y$-coordinate};
...
%% lines
\draw[blue, line width=3.5pt] (0,3)--(2,5);
\draw[blue, line width=3.5pt] (4,5)--(2,5);
\draw[blue, line width=3.5pt] (4,5)--(5,7);
