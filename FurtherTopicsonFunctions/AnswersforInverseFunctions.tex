...
\item $g^{-1}(t) = \frac{4t-3}{t}$
\item $g^{-1}(t) = \frac{t}{3t+1}$
...
\item $f^{-1}(x) = \frac{4x+1}{2-3x}$
\item $f^{-1}(x) = \frac{6x + 2}{3x - 4}$
...
\item $g^{-1}(t) = \frac{-3t - 2}{t + 3}$
\item $g^{-1}(t) = \frac{t-2}{2t-1}$ 
