...
\item  Let $P(n)$ be the sentence $\displaystyle{ \sum_{j=1}^{n} j^2 = \frac{n(n+1)(2n+1)}{6}}$. For the base case, $n=1$, we get
...
\frac{k(k+1)(2k+1)}{6} + \frac{6(k+1)^2}{6} &  \stackrel{?}{=}  & \frac{(k+1)(k+2)(2k+3)}{6}  \\ [10pt]
\frac{k(k+1)(2k+1)+6(k+1)^2}{6} &  \stackrel{?}{=}  & \frac{(k+1)(k+2)(2k+3)}{6}  \\ [10pt]
\frac{(k+1)(k(2k+1)+6(k+1))}{6} &  \stackrel{?}{=}  & \frac{(k+1)(k+2)(2k+3)}{6}  \\ [10pt]
\frac{(k+1)\left(2k^2+7k+6\right)}{6} &  \stackrel{?}{=}  & \frac{(k+1)(k+2)(2k+3)}{6}  \\ [10pt]
\frac{(k+1)(k+2)(2k+3)}{6} & = & \frac{(k+1)(k+2)(2k+3)}{6}  \, \checkmark \\ [10pt]
 \end{array} \]
