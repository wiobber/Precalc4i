...
At this stage, we know the equation of the hyperbola is \[ \frac{(y+1)^2}{4} - \frac{(x-3)^2}{a^2} = 1,\] so substituting $x=0$ and $y=3$ into this equation, we get $\frac{16}{4} - \frac{9}{a^2} = 1$ so $a^2 = 3$.  Hence, our final answer is  \[ \frac{(y+1)^2}{4} - \frac{(x-3)^2}{3} = 1.\] We leave it to the reader to check. 
