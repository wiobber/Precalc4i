...
\[ \begin{array}{rclr} 3x^2 - 6x + 3y^2 + 4y -4 & = & 0 & \\ 
 ...
 3\left(x^2 - 2x \right) + 3\left(y^2 + \frac{4}{3} y\right) & = & 4 & \text{factor out leading coefficients} \\ [10pt]
 3\left(x^2 - 2x + \underline{1} \right) + 3\left(y^2 + \frac{4}{3} y + \underline{\underline{\frac{4}{9}}} \right) & = & 4 + 3\underline{(1)} + 3\underline{\underline{\left(\frac{4}{9}\right)}} &  \text{complete the square in $x$, $y$} \\  [10pt]
 3(x - 1)^2 + 3\left(y + \frac{2}{3}\right)^2 & = & \frac{25}{3} & \text{factor} \\ [10pt]
 (x - 1)^2 + \left(y + \frac{2}{3}\right)^2 & = & \frac{25}{9} & \text{divide both sides by $3$} \\ [10pt]
 (x - 1)^2 + \left(y - \left(- \frac{2}{3} \right) \right)^2 & = & \left( \frac{5}{3} \right)^2 & \text{rewrite in the form of Equation \ref{standardcircle}.}
 \end{array} \]
...
{\bf Solution.}  Note that all points $(x,y)$ on the Unit Circle satisfy the equation $x^2+y^2 = 1$. Hence, our first step is  to replace $y$ with $\frac{\sqrt{3}}{2}$ and solve for $x$. 
 ...
 x^2 + \left(\frac{\sqrt{3}}{2}\right)^2 & = & 1 &  \\ [13pt]
 \frac{3}{4} + x^2 & = & 1 & \\
 x^2 & = & \frac{1}{4} & \\
