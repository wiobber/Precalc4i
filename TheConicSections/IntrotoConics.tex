...
In this chapter, we study the \index{conic sections ! definition} \textbf{Conic Sections} - literally `sections of a  cone'.  Imagine a double-napped cone as seen below being `sliced' by a plane. (The following interactive by Juan Carlos Ponce Campuzano is useful.)

% https://www.geogebra.org/classic/cajackyd
% https://www.geogebra.org/classic/knsdtswr

\begin{center}
    \geogebra{r5wyxdtp}{800}{600}
\end{center}
