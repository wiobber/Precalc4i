...
\begin{solution}
Use the Desmos graph below with the settings $h=2,\,k=-3,\,a=2,\,b=3$
...
\begin{solution}
Use the Desmos graph below with the settings $h=1,\,k=3,\,a=\sqrt{10},\,b=\sqrt{11}$
...
\begin{solution}
Use the Desmos graph below with the settings $h=-4,\,k=4,\,a=4,\,b=1$
...
\begin{solution}
Use the Desmos graph below with the settings $h=-1,\,k=3,\,a=3,\,b=2$
...
Center $\answer{(-1, 3)}$\\
Transverse axis on $\answer{y=3}$\\
Conjugate axis on $\answer{x=-1}$\\
...
\begin{solution}
Use the Desmos graph below with the settings $h=5,\,k=-2,\,a=\sqrt{20},\,b=4$
...
\begin{solution}
Use the Desmos graph below with the settings $h=4,\,k=2,\,a=\sqrt{8},\,b=\sqrt{18}$
...
\begin{problem}\label{buildhypefromgraphfirst}  % $\frac{x^2}{16} - \frac{y^2}{16} = 1$
...
$\answer{\frac{x^2}{16} - \frac{y^2}{16} = 1}$
\end{problem}


\begin{problem}\label{buildhypefromgraphlast} % $\frac{(y-4)^2}{4} - \frac{(x-4)^2}{3} = 1$
...
\begin{problem}
    ...
    $\answer{\frac{(x - 8)^{2}}{25} - \frac{(y - 2)^{2}}{4} = 1}$
...
\begin{solution}
$$\graph{4x^2+y^2-8x+4=0}$$

     $\frac{(x-1)^2}{1}+\frac{y^2}{4}=0$ \\
...
\begin{solution}
$$\graph{4x^2+9y^2-8x+54y+49=0}$$
\end{solution}

$\answer{\frac{(x-1)^2}{9}+\frac{(y+3)^2}{4} = 1}$ \\
\end{problem}
...
\begin{solution}
    $\frac{(x+3)^2}{2}+\frac{(y-1)^2}{1} = -\frac{3}{4}$ \\
There is no graph.
\end{solution}
...
\begin{problem}\label{hyperbolaeccentricity} 
