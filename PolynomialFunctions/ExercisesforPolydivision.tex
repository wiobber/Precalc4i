...
\begin{problem}
Find a quadratic polynomial with \underline{integer} coefficients which has $x = \frac{3}{5} \pm \frac{\sqrt{29}}{5}$ as its real zeros. 

$p(x) = \answer{5}x^{2} + \answer{-6}x + \answer{-4}$
...
\begin{itemize}
    \item $\frac{x - a}{x-a} = \answer{1}$
    \item $\frac{x^2 - a^2}{x-a} = \answer{x + a}$ 
    \item $\frac{x^3 - a^3}{x-a} = \answer{ x^2+ax+a^2}$ 
    \item $\frac{x^4 - a^4}{x-a} = \answer{ x^3 + ax^2 + a^2x + a^3}$ 
    \item $\frac{x^5 - a^5}{x-a} = \answer{x^4+ax^3 + a^2x^2+a^3x+a^4}$ 
\end{itemize}
...
\item $\frac{x^{10} - a^{10}}{x-a} = x^{9} + ax^8 + a^2x^7+a^3x^6+a^4x^5+a^5x^4+a^6x^3+a^7x^2+a^8x+a^9$

\item  $\frac{x^{n} - a^{n}}{x-a} = x^{n-1} + ax^{n-2} + a^2x^{n-3} + \ldots + a^{n-2} x + a^{n-1}$
