...
\item Given $f(x) = a_{n} x^{n} + a_{n-\mbox{\tiny$1$}} x^{n-\mbox{\tiny$1$}} + \ldots + a_2 x^2 + a_1 x + a_0$ with $n \in \mathbb{N}$ and $a_{n} \neq 0$, we say 
...
The end behavior of  polynomial function $f(x) = a_{n} x^{n} + a_{n-\mbox{\tiny$1$}} x^{n-\mbox{\tiny$1$}} + \ldots + a_2 x^2 + a_1 x + a_0$ with $a_{n} \neq 0$ matches the end behavior of $y = a_{n} x^{n}$.  
