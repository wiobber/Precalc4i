...
In order to write this set in a more compact way, we let $t_{k}$ denote the  the $k$th real number excluded from the domain.  That is,  $t_{k} =  \frac{\pi}{2} + \pi k$.  (This is sequence notation from Chapter \ref{SequencesandtheBinomialTheorem}.)
