...
\mfpicnumber{1} \opengraphsfile{AnswersforGraphsofOtherCircularFunctions} % mfpic settings added 
...
Start with $y = -\sin \left( t + \frac{\pi}{3} \right)$\\
Period: $2\pi$
...
Start with $y = -\frac{1}{3}\cos \left( \frac{1}{2}t + \frac{\pi}{3} \right)$\\
Period: $4\pi$
...
Start with $y = \sin \left( -t - \frac{\pi}{4} \right) - 2$ \\
Period: $2\pi$\\
