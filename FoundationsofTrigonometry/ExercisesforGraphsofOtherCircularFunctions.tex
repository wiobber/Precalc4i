...
\addplot[<->,line width=2pt,blue, domain=-4.75:4.75] {2*sec(180*x/3.14-180)};
...
\addplot[<->,line width=2pt,blue, domain=-5:5] {sec(90*x)+1};
...
\addplot[<->,line width=2pt,blue, domain=-4.75:4.75] {-tan(180*x/3.14+45)};
...
\node at (1.571,1) [above=8pt] {$(\frac{\pi}{2},1)$};
...
\addplot[<->,line width=2pt,blue, domain=-6.25:6.25] {tan(45*x)+1};
