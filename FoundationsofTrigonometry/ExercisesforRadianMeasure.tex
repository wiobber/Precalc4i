...
%Shaded Sector
\draw[fill=blue!30] (0,0) -- (15:4) arc (15:70:4) -- cycle;

% Circular Arcs
\draw[line width=1.5pt, -]
    (3.8637, 1.0353)
    arc[start angle=15,end angle=70,radius=4];

\draw[line width=1.5pt, <->]
    (1.410, 0.513)
    arc[start angle=20,end angle=65,radius=1.5];

% Rays
\draw[-] (1.3681,3.7588) -- (0,0) -- (3.8637, 1.0353);
