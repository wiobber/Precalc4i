...
\draw[very thick, -{Latex[length=2.5mm]},
...
\node[coordlabel,right] at (120:\R+0.42)
    {$\left(-\dfrac12,\dfrac{\sqrt3}{2}\right)$};

\node[coordlabel,right] at (135:\R+0.42)
    {$\left(-\dfrac{\sqrt2}{2},\dfrac{\sqrt2}{2}\right)$};

\node[coordlabel,right] at (150:\R+0.42)
    {$\left(-\dfrac{\sqrt3}{2},\dfrac12\right)$};

% --------------------------------------------------------------------
% Third quadrant coordinate labels
% --------------------------------------------------------------------

\node[coordlabel,right] at (210:\R+0.42)
    {$\left(-\dfrac{\sqrt3}{2},-\dfrac12\right)$};

\node[coordlabel,right] at (225:\R+0.42)
    {$\left(-\dfrac{\sqrt2}{2},-\dfrac{\sqrt2}{2}\right)$};

\node[coordlabel,right] at (240:\R+0.42)
    {$\left(-\dfrac12,-\dfrac{\sqrt3}{2}\right)$};
...
\node[coordlabel,left] at (300:\R+0.42)
    {$\left(\dfrac12,-\dfrac{\sqrt3}{2}\right)$};

\node[coordlabel,left] at (315:\R+0.42)
    {$\left(\dfrac{\sqrt2}{2},-\dfrac{\sqrt2}{2}\right)$};

\node[coordlabel,left] at (330:\R+0.42)
    {$\left(\dfrac{\sqrt3}{2},-\dfrac12\right)$};
