...
\node[anglelabel] at (30:2) {$\dfrac{\pi}{6}$};
\node[anglelabel] at (45:2) {$\dfrac{\pi}{4}$};
\node[anglelabel] at (60:2) {$\dfrac{\pi}{3}$};

\node[anglelabel,right] at (90:2) {$\dfrac{\pi}{2}$};

\node[anglelabel] at (120:2) {$\dfrac{2\pi}{3}$};
\node[anglelabel] at (135:2) {$\dfrac{3\pi}{4}$};
\node[anglelabel] at (150:2) {$\dfrac{5\pi}{6}$};

\node[anglelabel] at (210:2) {$\dfrac{7\pi}{6}$};
\node[anglelabel] at (225:2) {$\dfrac{5\pi}{4}$};
\node[anglelabel] at (240:2) {$\dfrac{4\pi}{3}$};

\node[anglelabel,right] at (270:2) {$\dfrac{3\pi}{2}$};

\node[anglelabel] at (300:2) {$\dfrac{5\pi}{3}$};
\node[anglelabel] at (315:2) {$\dfrac{7\pi}{4}$};
\node[anglelabel] at (330:2) {$\dfrac{11\pi}{6}$};
