...
\node[below] at (0.5,-0.12) {$\dfrac{\pi}{4}$};
\node[below] at (1.0,-0.12) {$\dfrac{\pi}{2}$};
\node[below] at (1.5,-0.12) {$\dfrac{3\pi}{4}$};
\node[below] at (2.0,-0.12) {$\pi$};
\node[below] at (2.5,-0.12) {$\dfrac{5\pi}{4}$};
\node[below] at (3.0,-0.12) {$\dfrac{3\pi}{2}$};
...
\draw[very thick,blue, domain=0.5:1.5, samples=80, smooth, variable=\u]
