...
\begin{problem} \label{findformulaforpowergraphlast}
...
\begin{image}
\begin{tikzpicture}[x=20pt,y=20pt]
  \draw[{Latex[length=5pt,width=3pt]}-{Latex[length=5pt,width=3pt]}, line width=1.25pt] (-4,0) -- (4,0);
  \node at (0,0.5) {$(+)$};
\end{tikzpicture}
\end{image}
\end{solution}
...
\begin{problem} \label{WindChillTemperature}
