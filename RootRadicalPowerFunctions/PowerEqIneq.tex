...
r(x)  & = & 3 (2-x)^{\frac{1}{3}} - x (2-x)^{-\frac{2}{3}} & \\  
      ...
      & = & \frac{3 (2-x)^{\frac{1}{3} + \frac{2}{3}}}{(2-x)^{\frac{2}{3}}} - \frac{x}{(2-x)^{\frac{2}{3}}} & \text{same base so add exponents}  \\  
...
\frac{3(t-4)^{\frac{2}{3}+\frac{1}{3}}}{3(t-4)^{\frac{1}{3}}}  + \frac{2t}{3(t-4)^{\frac{1}{3}}} & \geq & 0 & \text{\text{same base so add exponents}} \\ 
...
\xmalt{Sign diagram showing the intervals on which the function $r(x)$ is positive or negative. Dashed vertical line at $x=2$ indicates a vertical asymptote. The function is positive on $(-\infty,\frac{3}{2})$, positive on $(\frac{3}{2},2)$, and positive on $(2,\infty)$. The function has a zero at $x=\frac{3}{2}$.} 
\end{center}
\begin{image}
