...
\begin {problem} \label{radicalgraphexfirst}
...
\begin {problem} \label{radicalgraphexlast}
...
\begin {problem} \label{findformulaforsqrtgraphfirst}
...
\begin {problem} \label{findformulaforsqrtgraphlast}
...
\begin {problem} \label{findformulaforcubedrootgraphlast}
...
\begin{problem} \label{algfcngraphexfirst}
$f(x) = \sqrt{1 - x^{2}}$
...
\begin{problem} \label{algfcngraphexlas}
