...
% https://www.desmos.com/calculator/fni0liyn5n
\begin{center}
\desmos{fni0liyn5n}{800}{600}
\end{center}
...
% https://www.desmos.com/calculator/gyv8qfxhjs
\begin{center}
\desmos{gyv8qfxhjs}{800}{600}
\end{center}
...
% https://www.desmos.com/calculator/t2bfjpr8ar
\begin{center}
\desmos{t2bfjpr8ar}{800}{600}
\end{center}
...
\addplot[smooth,domain=-2:2, line width=1.5pt, blue] {(x^13)^(1/5)};

\addplot[smooth,domain=-2:0, line width=1.5pt, blue] {-(-x)^(13/5)};
...
\addplot[smooth,domain=0:5, line width=1.5pt,samples=200, blue] {x^(3/8)};
...
% https://www.geogebra.org/classic/eazjuzbg
\begin{center}
    \geogebra{eazjuzbg}{800}{600}
\end{center}
 ...
 % https://www.geogebra.org/classic/hr42fgrf

 \begin{center}
     \geogebra{hr42fgrf}{800}{600}
 \end{center}
...
% https://www.desmos.com/calculator/nto7sdaomz
\begin{center}
    \desmos{nto7sdaomz}{800}{600}
\end{center}
...
\begin{tikzpicture}[x=20pt,y=10pt]
  \draw[-{Latex[length=5pt,width=3pt]}, line width=0.8pt] (2,0) -- (-2,0);
  \draw[-{Latex[length=5pt,width=3pt]}, line width=0.8pt] (3,0) -- (7,0);
  \draw (0,-0.15) -- (0,0.15);
  \draw (2,-0.15) -- (2,0.15);
  \draw (3,-0.15) -- (3,0.15);
  \draw (5,-0.15) -- (5,0.15);
...
% https://www.desmos.com/calculator/m2hzmagth8
\begin{center}
\desmos{m2hzmagth8}{800}{600}
\end{center} 
...
% https://www.desmos.com/calculator/sjuhbguk78
\begin{center}
\desmos{sjuhbguk78}{800}{600}
\end{center}
...
\text{Portion of Population} & \text{Percent of Money Income} \\

\text{Lowest Quintile} & \text{ 3.1} \\

\text{Second Quintile} &\text{  8.2}  \\

\text{Middle Quintile} &  \text{14.3}  \\

\text{Fourth Quintile} &  \text{ 23.2}  \\

\text{Highest Quintile} &   \text{51.2 } \\
...
\text{percent wage earners, $x$} & \text{percent income, $L(x)$} \\
...
% https://www.desmos.com/calculator/nqjvl92ytp
\begin{center}
\desmos{nqjvl92ytp}{800}{600}
\end{center}
