...
\addplot[smooth, line width=1.5pt, penColor1, domain=0:4, samples=2] {x};
      ...
      \end{axis}
      \path (current axis.south) ++(0,-6pt) node {\scriptsize $f(x) = x^{\frac{1}{2}} x^{\frac{1}{2}} = (x^{\frac{1}{2}})^2 = x$, $x \geq 0$};
        \end{tikzpicture}
        \quad\quad\quad\quad
\begin{tikzpicture}[scale=1]font=\small
        \begin{axis}[
...
%% Main ray: f(x) = |x|, x < 0  (i.e. y = -x for x < 0)
\addplot[smooth, line width=1.5pt, penColor1, domain=-4:4, samples=2] {x};
      \end{axis}
...
\addplot[smooth, line width=1.5pt, penColor1, domain=-4:0, samples=2] {-x};
      \end{axis}
\path (current axis.south) ++(0,-6pt) node {\scriptsize $h(x) = (x^2)^{\frac{1}{2}} = |x|$ };
        \end{tikzpicture}
\end{image}    
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \node at (axis cs:1,1.75){\scriptsize $(1,1)$};
    \node at (axis cs:0,-0.5){\scriptsize $(0,0)$};
    \addplot[fpplot, domain=0:1.5, line width=1.25pt, ->] ({t^4},{t^3});
    \addplot[only marks, mark=*, mark size=2pt] coordinates {(0,0) (1,1)};
  \end{axis}
  \path (current axis.south) ++(0,-6pt) node {\scriptsize $f(x)=x^{\frac{3}{4}}$};
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \node at (axis cs:0,-0.5){\scriptsize $(0,0)$};
    \addplot[fpplot, domain=0:1.35, line width=1.25pt, ->] ({t^4},{t^5});
    \addplot[only marks, mark=*, mark size=2pt] coordinates {(0,0) (1,1)};
  \end{axis}
  \path (current axis.south) ++(0,-6pt) node {\scriptsize $f(x)=x^{\frac{5}{4}}$};
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \node at (axis cs:0.75,-0.5){\scriptsize $(0,0)$};
    \node at (axis cs:-1,1.75){\scriptsize $(-1,1)$};
    \addplot[fpplot, domain=-1.587:1.587, line width=1.25pt, ->] ({t^3},{t^2});
    \addplot[only marks, mark=*, mark size=2pt] coordinates {(0,0) (1,1) (-1,1)};
  \end{axis}
  \path (current axis.south) ++(0,-6pt) node {\scriptsize $f(x)=x^{\frac{2}{3}}$};
\end{tikzpicture}
...
% \input{PowerFunctions_pic10.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
    ...
    \addplot[fpplot, domain=-1.16:1.16, line width=1.25pt, ->] ({t^5},{t^8});
    \addplot[only marks, mark=*, mark size=2pt] coordinates {(0,0) (1,1) (-1,1)};
  \end{axis}
  \path (current axis.south) ++(0,-6pt) node {\scriptsize $f(x)=x^{\frac{8}{5}}$};
\end{tikzpicture}
...
% \input{PowerFunctions_pic11.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic12.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=100pt,
...
% \input{PowerFunctions_pic13.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic14.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic15.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic16.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic17.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic18.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
&
% \input{PowerFunctions_pic19.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic20.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic21.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic22.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic23.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic24.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic25.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=120pt,
...
% \input{PowerFunctions_pic27.tex}
...
% \input{PowerFunctions_pic28.tex}
\begin{tikzpicture}
  \begin{axis}[
    fplot,
    width=170pt,
