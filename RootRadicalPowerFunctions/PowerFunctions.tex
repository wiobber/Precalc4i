...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[->, line width=1.25pt] coordinates {(0,0) (4,4)};
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[line width=1.25pt] coordinates {(-4,4) (0,0)};
    \addplot[line width=1.25pt] coordinates {(0,0) (4,4)};
    \node at (axis cs:4,-0.5) {\scriptsize $x$};
    \node at (axis cs:0.5,5) {\scriptsize $y$};
  \end{axis}
