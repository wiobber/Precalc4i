...
$r(x) =   \dfrac{x}{1 - \ln(x)}$
\end{problem}    %(-\infty, e) \cup (e, \infty)$

\begin{problem}
$R(x) = \dfrac{x \ln(x)}{1 - \ln(x)}$ 
\end{problem}     % $(0,e) \cup (e, \infty)$
...
$f(x) = \ln(x) - \ln(5-x)$,  $f'(x) = \dfrac{1}{x} + \dfrac{1}{5-x}$, $f''(x) = \dfrac{1}{(5-x)^2} - \dfrac{1}{x^2}$
\end{problem}

\begin{problem}\label{logcurvesketchlast} 
$f(x) = \dfrac{\ln(x)}{x}$, $f'(x) = \dfrac{1 - \ln(x)}{x^2}$, $f''(x) = \dfrac{2 \ln(x) - 3}{x^3}$.
\end{problem}
