...
\begin{formula} \index{interest ! simple} \index{simple interest} \label{simpleinterest} \textbf{Simple Interest:} 
...
\begin{formula} \index{interest ! compound} \index{compound interest} \label{compoundinterest} \textbf{Compounded Interest:}  
...
\begin{formula} \index{interest ! compounded continuously} \index{continuously compounded interest} \label{} \textbf{Continuously Compounded Interest:} 
...
\begin{formula} \index{growth model ! uninhibited} \index{uninhibited growth} \label{lawofuninhibitedgrowth} \textbf{Uninhibited Growth:} 
...
\begin{formula} \index{radioactive decay} \label{radioactivedecay} \textbf{Radioactive Decay:}
...
\begin{formula} \index{Newton's Law of Cooling} \label{newtonslawofcooling} \textbf{Newton's Law of Cooling (Warming):}  
...
\begin{formula} \index{growth model ! logistic} \index{logistic growth} \label{logisticgrowth} \textbf{Logistic Growth:}  
