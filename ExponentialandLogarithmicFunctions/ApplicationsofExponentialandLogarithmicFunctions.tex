...
\begin{equation} \index{interest ! simple} \index{simple interest} \label{simpleinterest} \textbf{Simple Interest:} 
...
\begin{equation} \index{interest ! compound} \index{compound interest} \label{compoundinterest} \textbf{Compounded Interest:}  
...
\begin{equation} \index{interest ! compounded continuously} \index{continuously compounded interest} \label{} \textbf{Continuously Compounded Interest:} 
...
\begin{equation} \index{growth model ! uninhibited} \index{uninhibited growth} \label{lawofuninhibitedgrowth} \textbf{Uninhibited Growth:} 
...
\begin{equation} \index{radioactive decay} \label{radioactivedecay} \textbf{Radioactive Decay:}
...
\begin{equation} \index{Newton's Law of Cooling} \label{newtonslawofcooling} \textbf{Newton's Law of Cooling (Warming):}  
...
\begin{equation} \index{growth model ! logistic} \index{logistic growth} \label{logisticgrowth} \textbf{Logistic Growth:}  
