...
We can verify this analytically.  Using results  from Section \ref{IntroRational} and continuity, we know that $\lim_{x \rightarrow -\infty} \frac{x}{x+1} = 1$ and  $\lim_{x \rightarrow \infty} \frac{x}{x+1} = 1$.  Hence, it stands to reason that \[\lim_{x \rightarrow -\infty} g(x) = \lim_{x \rightarrow -\infty}  \ln \left(\frac{x}{x-1}\right) = \ln(1) = 0\] and, likewise,  $\lim_{x \rightarrow -\infty} g(x) = \ln(1) = 0$.  
