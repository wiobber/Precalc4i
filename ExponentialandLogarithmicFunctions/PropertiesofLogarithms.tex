...
\log \sqrt[3]{\dfrac{100 x^2}{yz^5}} & = & \log \left(\dfrac{100 x^2}{yz^5}\right)^{1/3} & \\  
																		& = & \frac{1}{3} \log\left(\dfrac{100 x^2}{yz^5}\right) & \mbox{Power Rule} \\ 
...
\log(x) + 2\log(y) - \log(z) & = & \log(x) + \log\left(y^2\right) - \log(z) & \mbox{Power Rule} \\   
                             & = & \log\left(xy^2\right) - \log(z) & \mbox{Product Rule} \\  
...
-\ln(t) - \frac{1}{2} & = & (-1)\ln(t) - \frac{1}{2}  &  \\ 
                             ...
                             & = & \ln\left(\dfrac{t^{-1}}{\sqrt{e}}\right) & \mbox{Quotient Rule} \\  
