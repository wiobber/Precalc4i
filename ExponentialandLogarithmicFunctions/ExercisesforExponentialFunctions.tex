...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=\left(\frac{1}{3}\right)^{x},\,a=1,\,b=1,\,h=1,\,k=0$

\begin{center} 
\desmos{qyxiza2f7s}{800}{600} 
\end{center}
...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=10^x,\,a=1,\,b=\frac{1}{2},\,h=-\frac{1}{2},\,k=-20$

\begin{center} 
\desmos{wrlj0hxwll}{800}{600} 
\end{center}
...
\begin{solution}
Use the Desmos graph below with the settings $f(t)=0.5^t,\,a=100,\,b=0.1,\,h=0,\,k=0$
...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=2^x,\,a=1,\,b=1,\,h=-1,\,k=-3$

\begin{center} 
\desmos{r24nw6gmxp}{800}{600} 
\end{center}
...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=2^x,\,a=-1,\,b=-1,\,h=0,\,k=3$

\begin{center} 
\desmos{d7emrkstf9}{800}{600} 
\end{center}
...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=2^x,\,a=1,\,b=2,\,h=6,\,k=0$

\begin{center} 
\desmos{oqffuc1nxc}{800}{600} 
\end{center}
...
\begin{solution}
You can use the same Desmos links in the solutions for Exercises \ref{expformfirsta} - \ref{expformlasta} to check your formulas for G(x).
...
\begin{solution}
$\frac{229437-230041}{230041} \approx 0.263 \%$.
\end{solution}

\item  If this percentage change remains constant, predict the population of Lake County in 2020.

\begin{solution}
Since 2020 is five years after 2015, we expect the population to decrease by  $0.263 \%$ of 229437, or approximately 603 people.  Hence, we approximate the population in 2020 as 228834.
\end{solution}
...
\begin{hint}
Definitions \ref{expfcnpointbaseform} and \ref{rrc} and ensuing discussion on that page is useful here.
\end{hint}

\begin{solution}
$P(t) = 230041(1-0.00263)^t = 230041(0.99737)^{t}$, $t \geq 0$.
\end{solution}
...
\begin{solution}
$A(t) = 230041(1 - 0.0005626)^{t} =  230041 (0.999474)^{t}$, $t \geq 0$.  Since 2050 is 40 years after 2010, using the model $P(t)$, we divide $\frac{40}{5} = 8$ and find $P(8) \approx 225,245$. On the other hand, $A(40) \approx 225,250$.  This is more than roundoff error.  There is a compounding effect which makes the functions $A(t)$ and $P(t)$ different. \footnote{See number \ref{preludetocompoundingexercise} above or, for more, see Section \ref{ExpLogApplications}.}
