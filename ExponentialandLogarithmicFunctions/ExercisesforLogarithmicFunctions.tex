...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[dashed, domain=-5:7] coordinates {(-4,-5) (-4,7)};
    % Horizontal asymptote y = -4
    \addplot[dashed, domain=-5:7] coordinates {(-5,-4) (7,-4)};
    % Slant line y = x
    \addplot[dashed, domain=-5:5] {x};

    % --- Exponential function: y = 3^(x+2) - 4 ---
    \addplot[
      thick,
      ->,
      >=stealth,
    ...
    % --- Logarithmic function: y = log_3(x+4) - 2 ---
    \addplot[
      thick,
      ->,
      >=stealth,
    ...
    % --- Labels ---
    \node[font=\small, anchor=south west] at (axis cs:3,4)
      {$y = 3^{x+2} - 4$};
    \node[font=\small, anchor=south east] at (axis cs:4,0)
      {$y = \log_{3}(x+4) - 2$};
    \node[font=\small, anchor=north east] at (axis cs:-4,6.5)
      {$x=-4$};
    \node[font=\small, anchor=south east] at (axis cs:6,-4)
      {$y=-4$};
    \node[font=\small, anchor=south west] at (axis cs:4,4)
      {$y=x$};
