...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=\log_2 x,\,a=1,\,b=1,\,h=-1,\,k=0$

\begin{center} 
\desmos{rslziwxr6g}{800}{600} 
\end{center}
...
range: $(-1, \infty)$
 ...
 $g(x)$ passes through the points:  $\left( -\frac{1}{2}, -1 \right)$, $(0,0)$, $(1,1)$\\
 Asymptote: $x = -1$ \\
\end{solution}
\end{problem}
...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=\log_\frac{1}{3} x,\,a=1,\,b=1,\,h=0,\,k=1$

\begin{center} 
\desmos{z2in5wjjxl}{800}{600} 
\end{center}

Domain of $g$:  $(0, \infty)$\\
 Range of $g$:  $(-\infty, \infty)$ \\
 $g(x)$ passes through the points:  $\left(\frac{1}{3}, 2 \right)$, $(1,1)$, $(3,0)$ \\
 Asymptote: $x = 0$ \\
\end{solution}
\end{problem}
...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=\log_{3}x,\,a=-1,\,b=1,\,h=2,\,k=0$

\begin{center} 
\desmos{dnrxqb6yri}{800}{600} 
\end{center}

Domain of $g$: $(2, \infty)$\\
 Range of $g$:  $(-\infty, \infty)$ \\
 $g(x)$ passes through the points:  $\left( \frac{7}{3},1 \right)$, $(3,0)$, $(5,-1)$ \\
 Asymptote: $x = 2$ \\
\end{solution}
\end{problem}
...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=\log x,\,a=2,\,b=1,\,h=-20,\,k=-1$

\begin{center} 
\desmos{fz3hzp3juz}{800}{600} 
\end{center}

Domain of $g$: $(-20, \infty)$\\
 Range of $g$:  $(-\infty, \infty)$\\
 $g(x)$ passes through the points:  $(-19, -1)$, $(-10,1)$, $(80,3)$\\
 Asymptote:  $x = -20$ \\
\end{solution}
\end{problem}
...
\begin{solution}
Use the Desmos graph below with the settings $f(t) = \log_{0.5}(t),\,a=10,\,b=\frac{1}{100},\,h=0,\,k=0$

\begin{center} 
\desmos{khwhvvjb0c}{800}{600} 
\end{center}

Domain of $g$: $(0, \infty)$ \\
  Range of $g$:  $(-\infty, \infty)$ \\
 $g(t)$ passes through the points:  $(50,10)$,   $(100,0)$, $(200,-10)$  \\
  Asymptote: $t= 0$\\
\end{solution}
\end{problem}
...
\begin{solution}
Use the Desmos graph below with the settings $f(t) = \log_{1.25}(t),\,a=1,\,b=-1,\,h=-1,\,k=2$

\begin{center} 
\desmos{im6ndw0yi7}{800}{600} 
\end{center}

 Domain of $g$: $(-\infty, 1)$ \\
  Range of $g$: $(-\infty, \infty)$  \\
 $g(t)$ passes through the points:  $(-0.25,3)$,  $(0,2)$, $(0.2,1)$ \\
  Asymptote: $t = 1$\\
\end{solution}
\end{problem}
...
\begin{solution}
Use the Desmos graph below with the settings $f(t) = \ln(t),\,a=-1,\,b=-1,\,h=-8,\,k=0$

\begin{center} 
\desmos{moovtjzsft}{800}{600} 
\end{center}

Domain of $g$:  $(-\infty, 8)$\\
 Range of $g$:$(-\infty, \infty)$\\
 $g(t)$ passes through the points:  $(8-e, -1) \approx (5.28, -1)$,\\
...
\begin{solution}
Use the Desmos graph below with the settings $f(t) = \ln(t),\,a=-10,\,b=\frac{1}{10},\,h=0,\,k=0$

\begin{center} 
\desmos{3qut55xcvg}{800}{600} 
\end{center}

Domain of $g$:  $(0, \infty)$\\
 Range of $g$:  $(-\infty, \infty)$\\
 $g(t)$ passes through the points:  $(10e^{-1}, 10) \approx (3.68. 10)$ \\
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \node[font=\small, anchor=south] at (axis cs:-2.5,-2) {$( -2.5, -2 )$};
...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=log_2 x,\,a=1,\,b=1,\,h=-3,\,k=-1$

\begin{center} 
\desmos{3oxtwliji6}{800}{600} 
\end{center}
...
\begin{solution}
Use the Desmos graph below with the settings $f(x)=log_2 x,\,a=-1,\,b=-1,\,h=-3,\,k=0$

\begin{center} 
\desmos{xgvnuamzvf}{800}{600} 
\end{center}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \node[font=\small, anchor=east] at (axis cs:2.5,2.5) {$(0.5, 2.5)$};
    \node[font=\small, anchor=east] at (axis cs:2.5,3) {$(1, 3)$};
    \node[font=\small, anchor=west] at (axis cs:2.5,3.5) {$(2, 3.5)$};

  \end{axis}
\end{tikzpicture}

\begin{solution}
Use the Desmos graph below with the settings $f(x)=log_2 x,\,a=\frac{1}{2},\,b=1,\,h=0,\,k=3$

\begin{center} 
\desmos{i2zecdcahu}{800}{600} 
\end{center}

$F(x) = \frac{1}{2} \log_{2}(x) + 3$
\end{solution}
\end{problem}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % Optional point labels
    \node[font=\small, anchor=south] at (axis cs:6,-1.5) {$(6,-0.5)$};
    \node[font=\small, anchor=north] at (axis cs:3,1) {$(3,0)$};
    \node[font=\small, anchor=north] at (axis cs:1.5,1.5) {$(1.5,0.5)$};

  \end{axis}
\end{tikzpicture}

\begin{solution}
Use the Desmos graph below with the settings $f(x)=log_2 x,\,a=--\frac{1}{2},\,b=\frac{1}{3},\,h=0,\,k=0$

\begin{center} 
\desmos{ctvgy8qojo}{800}{600} 
\end{center}

    $F(x) = -\frac{1}{2} \log_{2} \left( \frac{x}{3} \right)$
\end{solution}
\end{problem}
\end{question}
...
\begin{solution}
You can use the same Desmos links in the solutions for Exercises \ref{logformfirsta} - \ref{logformlasta} to check your formulas for G(x).
\end{solution}
\end{problem}
