...
% Label
\node[anchor=west, xshift=10pt] at (axis cs:0,-3)
    {\Large $(0,-3)$};

% Caption
\node at (axis cs:4,-4.4) {\Large $y=f(x)$};
...
% Labels
\node at (axis cs:1,2) [above right=6pt] {\Large $(1,2)$};
\node at (axis cs:1,-3) [below left=8pt] {\Large $(1,-3)$};
\node at (axis cs:3,-3) [below right=6pt] {\Large $(3,-3)$};
\node at (axis cs:3,4) [above right=6pt] {\Large $(3,4)$};
\end{axis}
\node at (axis cs:-2,-4) {\Large $s=F(t)$};
\end{tikzpicture}
\end{image}
\end{problem}
...
% Labels positioned away from graph and axes
\node at (axis cs:0,1) [above left=10pt] {\Large $(0,1)$};

\node at (axis cs:5/3,0) [below=12pt] {\Large $\left(\frac{5}{3},0\right)$};
...
% Coordinate labels
\node at (axis cs:-3,-4) [below left=8pt]
    {\Large $(-3,-4)$};

\node at (axis cs:-1,2) [above left=10pt]
    {\Large $(-1,2)$};

\node at (axis cs:3,2) [above right=8pt]
    {\Large $(3,2)$};
