...
\begin{multipleChoice}
    ...
    \begin{feedback}
        You cannot solve for y without using $\pm$ when you take the square root of both sides of your equation.
    \end{feedback}}
\end{multipleChoice}
\end{problem}
...
\addplot[line width=1.25pt, domain=0:180, samples=100, variable=\theta] ({5*cos(\theta)}, {5*sin(3*\theta)});
\end{axis}
\end{tikzpicture}
\end{center}
\end{problem} 
