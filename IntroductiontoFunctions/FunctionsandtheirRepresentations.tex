...
% Caption
\node at (6,-1.2) {\scriptsize The graph of $T=f(t)$.};
...
% Axis labels
\node[below] at (5,0) {\scriptsize $v$};
\node[left]  at (0,5) {\scriptsize $w$};
...
\node[below] at (-1,-0.35) {\scriptsize $-1$};
\node[below] at (1,-0.35)  {\scriptsize $1$};
\node[below] at (4,-0.35)  {\scriptsize $4$};

\node[left] at (-0.35,-3) {\scriptsize $-3$};
\node[left] at (-0.35,-2) {\scriptsize $-2$};
\node[left] at (-0.35,-1) {\scriptsize $-1$};
\node[left] at (-0.35,1)  {\scriptsize $1$};
\node[left] at (-0.35,2)  {\scriptsize $2$};
\node[left] at (-0.35,3)  {\scriptsize $3$};
\node[left] at (-0.35,4)  {\scriptsize $4$};

% Function y = x^2 - 4
\draw[thick, domain=-2:3, samples=200, ->]
  plot (\x, {\x*\x - 4});
...
% Point labels
\node[below] at (2,-0.5) {\scriptsize $(2,0)$};
\node[below] at (-2,-0.5) {\scriptsize $(-2,0)$};
\node[below] at (0,-4.25) {\scriptsize $(0,-4)$};
\node[right] at (1.1,-3.25) {\scriptsize $(1,-3)$};
...
% Axis numbers
\node[below] at (-1,-0.35) {\scriptsize $-1$};
\node[below] at (-3,-0.35) {\scriptsize $-3$};
\node[below] at (-4,-0.35) {\scriptsize $-4$};
\node[below] at (1,-0.35)  {\scriptsize $1$};
\node[below] at (3,-0.35)  {\scriptsize $3$};
\node[below] at (4,-0.35)  {\scriptsize $4$};
...
% Caption
\node at (0,-5.75) {\scriptsize Finding $F(0)=-4$.};
...
% Caption
\node at (0,-5.75) {\scriptsize Solving $F(v)=0$.};
...
\node[below] at (-2,-0.5) {\scriptsize $(-2,0)$};
\node[below] at (0,-4.25) {\scriptsize $(0,-4)$};
\node[right] at (1.1,-3) {\scriptsize $(1,-3)$};

% Text boxes
\node[draw, fill=white, inner sep=2pt] at (-3,-3) {\scriptsize project up};
\node[draw, fill=white, inner sep=2pt] at (2,2) {\scriptsize project down};
...
% Projection text
\node at (-3,-2) {\scriptsize project right};
\node[draw, fill=white, inner sep=2pt] at (2,2.5) {\scriptsize project left};

% Projection arrows
\draw[->, thin] (3,2.15) -- (1,2.15);
\draw[->, thin] (-4,-2.35) -- (-2,-2.35);
...
% Vertical test lines (double arrows)
\foreach \x in {-3,-2.5,-1.5,-1,0.5,1,1.5,2,2.5}
  \draw[<->, thin] (\x,-4.25) -- (\x,4.25);
...
% Axes
\draw[->] (-3,0) -- (5,0) node[right] {\scriptsize $t$};
\draw[->] (0,-2) -- (0,7) node[above] {\scriptsize $y$};

% Axis ticks and labels
\foreach \x in {-2,-1,1,2,3,4} \draw (\x,0.1) -- (\x,-0.1) node[below] {\scriptsize $\x$};
\foreach \y in {-1,1,2,3,5,6} \draw (0.1,\y) -- (-0.1,\y) node[left] {\scriptsize $\y$};

% Function curve
\draw[thick,->] plot [domain=-1.3:4.3, samples=100] (\x,{4+3*\x-\x*\x});

% Points
\foreach \x/\y in {-1/0, 0/4, 1.5/6.25, 2/6, 4/0}
    \filldraw (\x,\y) circle (2pt);

% Point labels
\node at (-1.75,0.5) {\scriptsize $(-1,0)$};
\node at (-0.75,4) {\scriptsize $(0,4)$};
\node at (1.5,6.75) {\scriptsize $(1.5,6.25)$};
\node at (2.75,6) {\scriptsize $(2,6)$};
...
\draw[thick] (0,5) -- (0,0);
\draw[thick] (0,0) -- (12,9);
\draw[thick] (0,5) -- (12,14);
\draw[thick] (-4,8) -- (8,17);
\draw[thick] (8,17) -- (12,14);
\draw[thick] (12,14) -- (12,9);

% Arrows
\draw[->] (0.5,-0.125) -- (12,8.5) node[midway, above] {length};
\draw[->] (-4,2.5) -- (-0.5,-0.125) node[midway, left] {$x$};
\draw[->] (-4.5,3) -- (-4.5,8) node[midway, left] {$x$};
...
Moving forward, we start with $x = 5$ and sample $V$ at steps of $5$ in its domain.  Our goal is to graph $y = V(x)$, so we plot our points $(x, V(x))$  using  the domain as a guide to help us set the horizontal bounds (i.e., the bounds on $x$) and the sample values from the range to help us set the vertical bounds (i.e., the bounds on $y$).   The right endpoint, $x = 26$, is included in the domain $0 < x \leq 26$ so we finish the graph by plotting the point $(26, V(26)) = (26,17576)$.  Below is the table of data and on the right is a graph produced with some help from \href{https://www.desmos.com/}{{desmos}}.
