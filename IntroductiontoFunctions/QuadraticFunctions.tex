...
\addplot[smooth, line width=1.5pt, violet] {2*x^2};
\addplot[smooth, line width=1.5pt, orange!60!brown] {3-x};
\addplot[smooth, domain=-1.5:1,line width=3.5pt, orange!60!brown] {3-x};
\addplot[smooth, domain=-1.5:1,line width=3.5pt, violet] {2*x^2};
...
\node[anchor=west, color=orange!60!brown] at (1.5,1.8) {$y=x-3$};
\node[anchor=west, color=violet] at (1.5,4.7) {$y=2x^2$};
      \end{axis}
        \end{tikzpicture}
\end{image}
\end{center}
...
\addplot[smooth, line width=1.5pt, violet] {x^2-2*x};
\addplot[smooth, line width=1.5pt, orange!60!brown] {1};
\addplot[smooth, domain=-4:-0.4,line width=3.5pt, orange!60!brown] {1};
\addplot[smooth, domain=-4:-0.4,line width=3.5pt, violet] {x^2-2*x};
\addplot[smooth, domain=-4:-0.4,line width=5pt, gray, opacity=0.5] {0};
\addplot[smooth, domain=2.4:4,line width=3.5pt, orange!60!brown] {1};
\addplot[smooth, domain=2.4:4,line width=3.5pt, violet] {x^2-2*x};
...
\node[anchor=west, color=orange!60!brown] at (-2.5,1.3) {$y=1$};
\node[anchor=west, color=violet] at (1,3) {$y=t^2-2t$};
      \end{axis}
        \end{tikzpicture}
\end{image}
\end{center}
...
\addplot[smooth, line width=1.5pt, violet] {x^2+1};
\addplot[smooth, line width=1.5pt, orange!60!brown] {2*x};
...
\node[anchor=west, color=orange!60!brown] at (0.5,0.8) {$y=x-3$};
\node[anchor=west, color=violet] at (-1.7,4.5) {$y=2x^2$};
      \end{axis}
        \end{tikzpicture}
\end{image}
\end{center}
...
\addplot[smooth, line width=1.5pt, violet] {abs(x-1)-1};
\addplot[smooth, line width=1.5pt, orange!60!brown] {2*x-x^2};
\addplot[smooth, domain=0:2,line width=3.5pt, orange!60!brown] {2*x-x^2};
\addplot[smooth, domain=0:2,line width=3.5pt, violet] {abs(x-1)-1};
...
\node[anchor=west, color=orange!60!brown] at (0.5,-1.7) {$y=2t-t^2$};
\node[anchor=west, color=violet] at (1.2,1.3) {$y=|t-1|-1$};
      \end{axis}
        \end{tikzpicture}
\end{image}
\end{center}
...
\node[anchor=south, color=blue] at (2.5,6.5) {$y=f(x)=x^2-x-6$};
      \end{axis}
        \end{tikzpicture}
\end{image}
...
\end{center}
   ...
   If we take a step back and look at the graphs of $f$ and $g$,  we notice that to obtain the graph of $g$ from the graph of  $f$, we reflect a \textbf{portion} of the graph of $f$ about the $x$-axis.  In general, if $g(x) = |f(x)|$, then: \[ g(x) = |f(x)| = \begin{mycases} 
      -f(x) &  \text{if $f(x)  < 0$, } \\
