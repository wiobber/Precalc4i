...
i(t) = \frac{(3 - 2t)^2 + 1}{2} & = & \frac{1}{2} (-2t + 3)^2 + \frac{1}{2} & = & \frac{1}{2} \left[ -2 \left(t - \frac{3}{2}\right) \right]^2 + \frac{1}{2} \\ [10pt]
...
$\frac{g(t) - 6}{-2}$ & $=$ & $\frac{ -2t^2-4t }{-2}$	& \text{Divide both sides by $-2$.}\\ [10pt]
$\frac{g(t) - 6}{-2} + (1)^2$ & $=$ & $t^2+2t +(1)^2$	& \text{Add $\left( \frac{1}{2} (2) \right)^2$ to both sides.} \\ [10pt]
$\frac{g(t) - 6}{-2} + 1$ & $=$ & $(t+1)^2$ & \text{Factor the prefect square trinomial.} \\ [10pt]
$\frac{g(t) - 6}{-2}$  & $=$ & $(t+1)^2 - 1$ & \\ [10pt]
...
$\frac{f(x)-c}{a}$    & $=$  & $x^2 + \frac{b}{a} x$  & \\ [10pt]
$\frac{f(x)-c}{a} + \left(\frac{b}{2a}\right)^2$   & $=$ & $x^2 + \frac{b}{a} x + \left(\frac{b}{2a}\right)^2$  & \text{Add $ \left(\frac{b}{2a}\right)^2  $ to both sides.}\\ [10pt]
$\frac{f(x)-c}{a}  + \frac{b^2}{4a^2}$    & $=$ & $\left(x + \frac{b}{2a}\right)^2$  & \text{Factor the perfect square trinomial.} \\ [10pt]
$\frac{f(x)-c}{a}$    & $=$  & $\left(x + \frac{b}{2a}\right)^2   -  \frac{b^2}{4a^2}$ & \text{Solve for $f(x)$.}\\ [10pt]
$f(x)-c$ & $=$ & $a \left[ \left(x + \frac{b}{2a}\right)^2   -  \frac{b^2}{4a^2}\right]$ & \\ [10pt]
$f(x)-c$ & $=$ & $a\left(x + \frac{b}{2a}\right)^2   -  a\frac{b^2}{4a^2}$ &  \\ [10pt]
$f(x)$ & $=$ & $a\left(x + \frac{b}{2a}\right)^2 - \frac{b^2}{4a} + c$  & \\ [10pt]
...
\item  To find the zeros of $P$, we set $P(x) = 0$ and solve  $-1.5x^2+170x-150=0$. Factoring here would be challenging to say the least, so we use the Quadratic Formula,  Equation \ref{quadraticformulafunction}.  Identifying $a = -1.5$, $b=170$ and $c=-150$, we obtain\[ \begin{array}{rclr}
 ...
 x & = & \frac{-b \pm \sqrt{b^2-4ac}}{2a} & \\ [10pt]
   & = & \frac{-170 \pm \sqrt{170^2 - 4(-1.5)(-150)}}{2(-1.5)} & \\ [10pt]
	 & = & \frac{-170 \pm \sqrt{28000}}{-3} & \\ [10pt]
	 & = & \frac{170 \pm 20 \sqrt{70}}{3} & \\ [10pt]
...
Combining these into one sign diagram, we have that our solution is $[0,2]$.  Graphically, to check $2t-t^2 \geq |t-1|-1$, we set $h(t) = 2t-t^2$ and $i(t) = |t-1|-1$ and look for the $t$ values where the graph of $h$ intersects or is above the the graph of $i$. Here we show both the combined sign chart and the graphs.
...
\begin{cases} 
 ...
 g(x) = \begin{cases} 
   ...
   \end{cases} \\ \end{array} \]  \normalsize Going through the usual machinations results in the second graph.  Compare it to the first graph.  Notice anything? 
