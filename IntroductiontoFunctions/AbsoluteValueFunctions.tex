...
\addplot[smooth, line width=3.5pt, penColor1, domain=-4:0, samples=2] {-x};
%% Arrow at the end of the ray (open end, going up-left)
\addplot[
  line width=3.5pt,
  penColor1,
  domain=-4:-3.6,
...
%% Main ray: f(x) = |x|, x < 0  (i.e. y = -x for x < 0)
\addplot[smooth, line width=3.5pt, penColor1, domain=0:4, samples=2] {x};
%% Arrow at the end of the ray (open end, going up-left)
\addplot[
  line width=3.5pt,
  penColor1,
