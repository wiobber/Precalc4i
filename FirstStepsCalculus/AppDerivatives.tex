...
% https://www.geogebra.org/graphing/zm2jxnpw
    \geogebra{zm2jxnpw}{800}{600}
...
\begin{explanation}To make use of Theorem \ref{firstderivatveandgraphs}, we make a sign diagram for $f'(x)$.  Since $f'$ is a polynomial, $f'$ is continuous so the per the Intermediate Value Theorem, Theorem \ref{IVT}, $f'$ will only change sign on either side of zeros. Hence, our first step is to solve  $f'(x) = 0$.  
...
\node[above] at (1,0.15) {$0$};
\draw (3,0.08) -- (3,-0.08);
\node[below] at (3,-0.12) {$3$};
\node[above] at (3,0.15) {$0$};

\node[above] at (0.5,0.15) {$(+)$};
\node[above] at (3.5,0.15) {$(+)$};
\node[above] at (2,0.15) {$(-)$};
\node[right] at (\xmax+0.15,0.55) {$f'(x)$};

\draw[->, gray] (0.5,-0.9) -- (0.5,-0.15);
\draw[->, gray] (2,-0.9) -- (2,-0.15);
\node[right] at (\xmax+0.15,-0.15) {$x$};
\node[below] at (0.5,-0.9) {$-3$};
\node[below] at (2,-0.9) {$0$};
\draw[->, gray] (3.5,-0.9) -- (3.5,-0.15);
\node[below] at (3.5,-0.9) {$4$};
\end{tikzpicture}
\end{image}

Next, we use Theorem \ref{firstderivatveandgraphs} to interpret what the sign diagram for $f'(x)$ means for the graph of $y = f(x)$:
...
\draw (1,0.08) -- (1,-0.08);
\node[below] at (1,-0.12) {$-1$};
\node[above] at (1,0.15) {$\rightarrow$};
\draw (3,0.08) -- (3,-0.08);
\node[below] at (3,-0.12) {$3$};
\node[above] at (3,0.15) {$\rightarrow$};

\node[above] at (0.5,0.15) {$\nearrow$};
\node[above] at (3.5,0.15) {$\nearrow$};
\node[above] at (2,0.15) {$\searrow$};
\node[right] at (\xmax+0.15,0.55) {$f(x)$};
...
% https://www.desmos.com/calculator/8jwjfz66ye
\begin{center}
    \desmos{8jwjfz66ye}{800}{600}
\end{center}
...
\begin{explanation}    \begin{enumerate}  \item In order to make a sign diagram for $f'(x)$, we rewrite $f'(x)$ as a single fraction:  \[f'(x) = \dfrac{4}{3} x^{1/3} - \dfrac{4}{3} x^{-2/3} =  \dfrac{4x^{1/3}}{3}  - \dfrac{4}{3x^{2/3}}  = \dfrac{4x^{1/3}}{3} \cdot \dfrac{x^{2/3}}{x^{2/3}} - \dfrac{4}{3x^{2/3}} = \dfrac{4x}{3x^{2/3}} - \dfrac{4}{3x^{2/3}}   = \dfrac{4x-4}{3x^{2/3}}.\]
...
\node[above] at (1,0.15) {\textinterrobang};
\draw (3,0.08) -- (3,-0.08);
\node[below] at (3,-0.12) {$1$};
\node[above] at (3,0.15) {$0$};
...
\draw[->, gray] (2,-0.9) -- (2,-0.15);
\node[right] at (\xmax+0.15,-0.15) {$x$};
\node[below] at (0.5,-0.9) {$-1$};
\node[below] at (2,-0.9) {$1/2$};
\draw[->, gray] (3.5,-0.9) -- (3.5,-0.15);
\node[below] at (3.5,-0.9) {$2$};
\end{tikzpicture}
\end{image}


Using  Theorem \ref{firstderivatveandgraphs}, we get:
...
% https://www.desmos.com/calculator/2n3wtmceu5
\begin{center}
    \desmos{2n3wtmceu5}{800}{600}
\end{center}
...
% https://www.geogebra.org/classic/p7wayh3n
\begin{center}
\geogebra{p7wayh3n}{800}{600}
\end{center}
...
% https://www.geogebra.org/classic/jv4awzcx
\begin{center}
\geogebra{jv4awzcx}{800}{600}
\end{center}
...
\begin{explanation} To analyze the concavity of the graph of $f$, we need to make a sign diagram for $f''(x)$.  
...
\draw[->, gray] (3,-0.9) -- (3,-0.15);
\draw[->, gray] (1,-0.9) -- (1,-0.15);
\node[right] at (\xmax+0.15,-0.15) {$x$};
\node[below] at (1,-0.9) {$0$};
\node[below] at (3,-0.9) {$2$};

\end{tikzpicture}

\end{image}

Using Theroem \ref{secondderivatveandgraphs}, we get the following:
...
% https://www.desmos.com/calculator/koqauksa1g
\begin{center}
    \desmos{koqauksa1g}{800}{600}
\end{center}
...
\draw[<->] (\xmin,0) -- (\xmax,0);
\draw (1,0.08) -- (1,-0.08);
\node[below] at (1,-0.12) {$-2$};
\node[above] at (1,0.15) {$0$};
\draw (3,0.08) -- (3,-0.08);
\node[below] at (3,-0.12) {$0$};
\node[above] at (3,0.15) {?};
...
Using Theorem \ref{secondderivatveandgraphs} we get:
...
\node[above] at (0.5,0.15) {C. Up};
\node[above] at (3.5,0.15) {C. Up};
\node[above] at (2,0.15) {C. Down};
\node[right] at (\xmax+0.15,0.55) {$f(x)$};
...
% https://www.desmos.com/calculator/rc9moeukik

\begin{center}
    \desmos{rc9moeukik}{800}{600}
\end{center}
...
\begin{example}\label{graphfromderivativegraphex} Below is the graph of the \textbf{derivative} of a function.  Assume that both $\lim_{x \rightarrow -\infty} f'(x) = -\infty$ and $\lim_{x \rightarrow \infty} f'(x) = -\infty$.

% https://www.desmos.com/calculator/kk5rp0t6nc
\begin{center}
\desmos{kk5rp0t6nc}{800}{600}
\end{center}
...
Hence, we know by Theorem \ref{secondderivatveandgraphs}:
...
\node[above] at ({(\xmin+\crit)/2},0.15) {C. Up};
\node[above] at ({(\crit+\xmax-0.6)/2},0.10) {C. Down};
\node[right] at (\xmax+0.15,0.55) {$f(x)$};
...
\item   A plausible graph of $y = f(x)$  is below. Note that we cannot determine any $y$-coordinates (why not?)

% https://www.desmos.com/calculator/idw1bg1sga
\begin{center}
\desmos{idw1bg1sga}{800}{600}
 \end{center}
