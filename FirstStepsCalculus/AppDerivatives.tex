...
\node[above] at ({(\xmin+\crit)/2},0.15) {Down};
\node[above] at ({(\crit+\xmax-0.6)/2},0.10) {Up};
\node[right] at (\xmax+0.15,0.55) {$f(x)$};
...
\node[above] at (0.5,0.15) {Up};
\node[above] at (3.5,0.15) {Up};
\node[above] at (2,0.15) {Down};
\node[right] at (\xmax+0.15,0.55) {$f(x)$};
...
\node[above] at ({(\xmin+\crit)/2},0.15) {Up};
\node[above] at ({(\crit+\xmax-0.6)/2},0.10) {Down};
\node[right] at (\xmax+0.15,0.55) {$f(x)$};
