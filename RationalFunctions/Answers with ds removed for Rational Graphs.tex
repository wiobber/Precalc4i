...
\begin{document}
	\author{Stitz-Zeager}
	\xmtitle{Answers for Rational Graphs}{}
...
\item \begin{multicols}{2} \raggedcolumns
$r(z) = -z-2+\frac{6}{3-z} = \frac{z^2-z}{3-z}$\\[10pt]
Domain: $(-\infty, 3) \cup (3, \infty)$\\
...
\item \begin{multicols}{2} \raggedcolumns
$f(x) = \frac{5x}{9-x^2} - x = \frac{x^{3} - 4x}{9-x^{2}}$\\[10pt]
...
\item \begin{multicols}{2} \raggedcolumns
$g(t) = \frac{1}{2}t-1 + \frac{t+1}{t^2+1} = \frac{t(t^2-2t+3)}{2t^2+2}$\\[10pt]
Domain: $(-\infty,\infty)$\\
$t$-intercept: $(0,0)$\\
$y$-intercept:  $(0,0)$\\
...
\item $f(x) = \frac{1}{x - 2}$
\item $F(x) = \frac{x-3}{(x-2)(x-3)} = \frac{x-3}{x^2-5x+6}$
...
\item $g(t) =\frac{t^2-1}{t}$
\item $G(t) = \frac{(t^2-1)(t+1)}{t(t+1)} = \frac{t^3+t^2-t-1}{t^2+t}$
