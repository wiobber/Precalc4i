...
\node[anchor=north] at (1.5,-0.1) {VA: $x=0$};
...
\node[anchor=north] at (2.8,-0.1) {VA: $x=3/2$};
...
\node[anchor=north] at (-1.5,3) {VA: $t=0$};
...
\node[anchor=north] at (-2.5,3) {VA: $t=-1$};
...
\node[anchor=south] at (0,1.5) {Multiply each $y$-coordinate};
\node[anchor=south] at (0,0.5) {by $-3$};
