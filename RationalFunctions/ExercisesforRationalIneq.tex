...
\begin{problem}
$\frac{1}{t + 3} + \frac{1}{t - 3} = \frac{t^{2} - 3}{t^{2} - 9}$ 
...
$\frac{4z- z^3}{z^{2} - 9} = 4z$  

\begin{selectAll}
    \choice{$t=-4\sqrt{2}$}
    \choice[correct]{$t=-2\sqrt{2}$}
    \choice[correct]{$t=0$}
    \choice[correct]{$t=2\sqrt{2}$}
    \choice{$t=4\sqrt{2}$}
  \end{selectAll}
...
For what value is the rational function equal to $0$? 
...
Use test points to determine all intervals which are part of the solution set.
    ...
    \begin{selectAll}
    \choice{$(-\infty,0]$} \choice[correct]{$[(]0,\infty)$}
  \end{selectAll}
\end{exercise}
\end{problem} 
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % Axis labels
    \node at (axis cs:7,-0.5) { $x$};
    \node at (axis cs:0.5,8) { $y$};
    ...
    \node at (axis cs:3.5,-1) { $(3,0)$};

    % Caption
    \node[below] at (rel axis cs:0.5,0) 
      { $y=f(x)$, asymptotes: $x=0$, $y=1$};
  \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % Axis labels
    \node at (axis cs:6,-0.5) { $t$};
    \node at (axis cs:0.5,4) { $y$};
    ...
    \node at (axis cs:3.75,1.25) { $(3,1)$};
    \node at (axis cs:0,-1.25) { $(1,-1)$};

    % Caption
    \node[below] at (rel axis cs:0.5,0) 
      { $y=g(t)$, asymptotes: $t=2$, $y=0$};
  \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \node at (axis cs:-2.5,1) { $(-1,1)$};

    % Hole at (1,1)
    \addplot[only marks, mark=o, mark size=2pt, thick] coordinates {(1,1)};
    \node at (axis cs:3,1) { hole at $(1,1)$};

    % Caption
    \node[below] at (rel axis cs:0.5,0) 
      { $y=r(z)$, asymptotes: $z=0$, $y=0$};
  \end{axis}
\end{tikzpicture}
