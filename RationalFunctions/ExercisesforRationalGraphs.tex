...
$\phantom{f(x)} = \frac{x(x-2)(x+2)}{-(x-3)(x+3)}$\\[10pt]
Domain: $(-\infty, -3) \cup (-3, 3) \cup (3, \infty)$\\
...
$\lim_{t \rightarrow -2^{-}} g(t) = -\infty$, $\lim_{t \rightarrow -2^{+}} g(t) = \infty$\\
$\lim_{t \rightarrow 0^{-}} g(t) = \infty$, $\lim_{t \rightarrow 0^{+}} g(t) = -\infty$\\
...
\footnote{Once you've done the six-step procedure, \href{https://www.desmos.com/calculator/gdjsplqomf}{click here to see}  the graph of this function on the window $[0, 12] \times [0, 0.25]$ \ldots}
\end{problem} 
