...
We want $A^{-1}$ to satisfy two equations, $A^{-1}A = I_2$ and $AA^{-1} = I_2$, making $A^{-1}$ necessarily a $2 \times 2$ matrix.\footnote{Since matrix multiplication isn't necessarily commutative, at this stage, these are two different equations.}  Hence,  $A^{-1}$ has the form 
...
\left[ \begin{array}{rr} 2 & -3 \\ 3 & 4 \\ \end{array} \right] \left[ \begin{array}{rr} x_1 & x_2 \\ x_3 & x_4 \\ \end{array} \right]  & = & \left[ \begin{array}{rr} 1 & 0 \\ 0 & 1 \\ \end{array} \right] \\  

\left[ \begin{array}{rr} 2x_1 - 3x_3 &  2x_2 - 3x_4 \\ 3x_1 +4x_3 &  3x_2 +4x_4 \\ \end{array} \right]  & = & \left[ \begin{array}{rr} 1 & 0 \\ 0 & 1 \\ \end{array} \right] \\
...
\left\{ \begin{array}{rcr} 2x_1-3x_3 & = & 1 \\ 3x_1+4x_3 & = & 0 \\ \end{array} \right.

&

\left\{ \begin{array}{rcr} 2x_2-3x_4 & = & 0 \\ 3x_2+4x_4 & = & 1 \\ \end{array} \right.
...
&
\left[ \begin{array}{rr|r} 1 & 0 & \frac{4}{17} \\  0 & 1 & -\frac{3}{17} \\ \end{array} \right] \\
...
&
\left[ \begin{array}{rr|r} 1 & 0 & \frac{3}{17} \\  0 & 1 & \frac{2}{17} \\ \end{array} \right] \\
...
\left[
\begin{array}{c|rr}
\multirow{2}{*}{\large\textit{A}} & 1 & 0 \\ & 0 & 1
\end{array}
\right]
&
\xrightarrow{\text{Gauss Jordan Elimination}}
...
\left[
\begin{array}{c|rr}
\multirow{2}{*}{\large $I_2$} & x_1 & x_2 \\ & x_3 & x_4
\end{array}
\right]
...
\left[ \begin{array}{c|c} A & I_2 \end{array} \right]
...
\left[ \begin{array}{c|c} I_2 & A^{-1} \end{array} \right] 
...
\left[ \begin{array}{rrr|rrr} 1 & \frac{1}{3} & 0 & \frac{17}{39} & -\frac{2}{39} & -\frac{2}{13} \\  0 & 1 & 0 &-\frac{10}{13} & -\frac{8}{13} & \frac{15}{13} \\  0 & 0 & 1 & -\frac{2}{13} & \frac{1}{13} & \frac{3}{13} \\ \end{array} \right]
...
\left[ \begin{array}{rrr|rrr} 1 & 0 & 0 & \frac{9}{13} & \frac{2}{13} & -\frac{7}{13} \\  0 & 1 & 0 &-\frac{10}{13} & -\frac{8}{13} & \frac{15}{13} \\  0 & 0 & 1 & -\frac{2}{13} & \frac{1}{13} & \frac{3}{13} \\ \end{array} \right]
...
\item $X = A^{-1}B = \left[ \begin{array}{rrr} \frac{9}{13} & \frac{2}{13} & -\frac{7}{13} \\  -\frac{10}{13} & -\frac{8}{13} & \frac{15}{13} \\  -\frac{2}{13} & \frac{1}{13} & \frac{3}{13} \end{array} \right] \left[ \begin{array}{r} 26 \\  39 \\  117 \end{array}\right] =  \left[ \begin{array}{r} -39 \\  91 \\  26 \end{array}\right]$.  Our solution is $(-39,91,26)$.

\item $X = A^{-1}B = \left[ \begin{array}{rrr} \frac{9}{13} & \frac{2}{13} & -\frac{7}{13} \\  -\frac{10}{13} & -\frac{8}{13} & \frac{15}{13} \\  -\frac{2}{13} & \frac{1}{13} & \frac{3}{13}  \end{array} \right] \left[ \begin{array}{r} 4 \\  2 \\  5 \end{array}\right] =  \left[ \begin{array}{r} \frac{5}{13} \\  \frac{19}{13} \\  \frac{9}{13} \end{array}\right]$.  We get $\left( \frac{5}{13},  \frac{19}{13},  \frac{9}{13}   \right)$.
...
\item  $V\!B_1 = 10 V$ and $V\!B_2 = 5 V$

\item  $V\!B_1 = 10 V$ and $V\!B_2 = 0 V$
...
\item  $V\!B_1 = 0 V$ and $V\!B_2 = 10 V$

\item  $V\!B_1 = 10 V$ and $V\!B_2 = 10 V$
...
\[ \left\{ \begin{array}{rcl} 2i_1 - i_2-i_4 & = & V\!B_1 \\
-i_1 + 3i_2 - i_3 - i_4 & = & 0 \\
-i_2 + 2i_3 - i_4 & = & -V\!B_2 \\
-i_1 - i_2-i_3 + 4i_4 & = & 0 \\  \end{array} \right.\]
...
&
 ...
 X = \left[ \begin{array}{r} i_1 \\ i_2 \\ i_3 \\ i_4 \\ \end{array} \right]
 
&

 B = \left[ \begin{array}{r} V\!B_1 \\ 0 \\ -V\!B_2 \\ 0 \end{array} \right] 
 \end{array}\]   

When we input the matrix $A$ into a calculator or graphing utility, we find the matrix inverse $A^{-1}$ as follows:
...
To solve the four systems given to us, we find $X=A^{-1}B$ where the value of $B$ is determined by the given values of $V\!B_1$ and $V\!B_2$
...
\item  For $V\!B_1 = 10 V$ and $V\!B_2 = 5 V$, the calculator gives $i_1 = 10.625 \, \, mA$, $i_2 = 6.25 \, \, mA$, $i_3 = 3.125 \, \, mA$, and $i_4 = 5 \, \, mA$. 

We include screenshot below for this part (and this part only!) for reference, as the other solutions are given similarly.


\centerline{\includegraphics[width=2in]{./MatMethodsGraphics/MATRIXINVERSE03.jpg}}


\item  By keeping  $V\!B_1 = 10 V$ and setting $V\!B_2 = 0 V$, we are removing the effect of the second battery. We get $i_1 = 16.25 \, \, mA$, $i_2 = 12.5 \, \, mA$, $i_3 = 11.25 \, \, mA$, and $i_4 = 10 \, \, mA$.  


\item  Here, we  are zeroing out $V\!B_1$ and making $V\!B_2 = 10$, essentially removing the effect of the first battery.  We find $i_1 = -11.25 \, \, mA$, $i_2 = -12.5 \, \, mA$, $i_3 = -16.25 \, \, mA$, and $i_4 = -10 \, \, mA$, where the negatives indicate that the current is flowing in the opposite direction as is indicated on the diagram. The reader is encouraged to study the symmetry here, and if need be, hold up a mirror to the diagram to literally `see' what is happening.

\item  For $V\!B_1 = 10 V$ and $V\!B_2 = 10 V$, we get $i_1 = 5 \, \, mA$, $i_2 = 0 \, \, mA$, $i_3 = -5 \, \, mA$, and $i_4 = 0 \, \, mA$.  The mesh currents $i_2$ and $i_4$ being zero is a consequence of both batteries `pushing' in equal but opposite directions, causing the net flow of electrons in these two regions to cancel out. \qed
