...
\item $-B = \left[ \begin{array}{rrr} -1 & -2 & -3 \end{array} \right]$
...
\begin{problem}
Now let \[S = \left[ \begin{array}{rr} \frac{2}{3} & \frac{2}{3} \\   \frac{1}{3} & \frac{1}{3} \end{array} \right]\]  Show that $Q^{n} \rightarrow S$ as $n \rightarrow \infty$.
\end{problem}
...
\begin{problem}\label{triangexfirst} 
Give an example of a matrix which is neither upper triangular nor lower triangular.
\end{problem}

\begin{problem}
Is the product of two $n \times n$ upper triangular matrices always upper triangular?
\end{problem}

\begin{problem}
Is the product of two $n \times n$ lower triangular matrices always lower triangular?
\end{problem}

\begin{problem}
Given the matrix \[A = \left[ \begin{array}{rr} 1 & 2 \\ 3 & 4 \end{array} \right]\] write $A$ as $LU$ where $L$ is a lower triangular matrix and $U$ is an upper triangular matrix?
\end{problem}

\begin{problem}\label{triangexlast}
