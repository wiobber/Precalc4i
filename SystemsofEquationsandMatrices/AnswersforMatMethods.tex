...
\item $A^{-1} = \left[ \begin{array}{rr} -2 & 1 \\  \frac{3}{2} & -\frac{1}{2} \end{array} \right]$
...
\item $E^{-1} = \left[ \begin{array}{rrr} -1 & 8 & 4 \\ 1 & -3 & -1 \\ 1 & -6 & -3 \end{array} \right] \vphantom{\left[ \begin{array}{rrr} -\frac{5}{2} & \frac{7}{2} & \frac{1}{2} \\  \frac{7}{4} & -\frac{9}{4} & -\frac{1}{4} \\  -\frac{1}{6} & \frac{1}{6} & \frac{1}{6} \end{array} \right]}$
...
\item $G \vphantom{\left[ \begin{array}{rrrr} 16 & 0 & 3 & 0 \\  -90 & -\frac{1}{2} & -\frac{35}{2} & \frac{7}{2} \\  5 & 0 & 1 & 0 \\  -36 & 0 & -7 & \hphantom{-}1 \end{array} \right]}$ is not invertible
\item $H^{-1} = \left[ \begin{array}{rrrr} 16 & 0 & 3 & 0 \\  -90 & -\frac{1}{2} & -\frac{35}{2} & \frac{7}{2} \\  5 & 0 & 1 & 0 \\  -36 & 0 & -7 & \hphantom{-}1 \end{array} \right]$
