...
\begin{definition}  \label{lineareqnnvariables}  A \index{equation ! linear of $n$ variables}\index{linear equation ! $n$ variables}\textbf{linear equation in \textit{n} variables}, $x_1$, $x_2$, \ldots, $x_{n}$, is an equation of the form:

 \[a_1 x_1 + a_2 x_2 + \ldots + a_{n} x_{n} = c,\]
 
 
  where $a_1$, $a_2$, \dots $a_{n}$  and $c$ are real numbers and at least one of $a_1$, $a_2$, \dots, $a_{n}$ is nonzero.
...
\[ \left\{ \begin{array}{rcr} x-\frac{1}{3}y+\frac{1}{2}z  & = & 1 \\  
y - \frac{1}{2} z & = & 4 \\  
z & = & -1 \\ \end{array} \right.\]  
...
\begin{definition} \label{systemtriangularform} A system of linear equations with variables $x_1$, $x_2$, \ldots $x_{n}$ is said to be in \index{system of equations ! triangular form} \index{triangular form} \textbf{triangular form} provided all of the following conditions hold:
...
\item  $\left\{ \begin{array}{rcr} 3x_1 +x_2 + x_4 & = & 6 \\ 2x_1 + x_2 -x_3  & = & 4  \\  x_2 -3x_3 -2x_4 & = & 0 \end{array} \right.$
...
\item  For our last system, we begin by multiplying $E1$ by $\frac{1}{3}$ to get a coefficient of $1$ on  $x_1$.
...
(E1) & x_1 + \frac{1}{3}x_2 + \frac{1}{3}x_4 & = & 2 \\  
(E2) &        \frac{1}{3} x_2 -x_3 -\frac{2}{3}x_4 & = & 0  \\  
(E3) &  x_2 -3x_3 -2x_4 & = & 0 \\
...
(E1) & x_1 + \frac{1}{3}x_2 + \frac{1}{3}x_4 & = & 2 \\   
(E2) &    x_2 -3x_3 -2x_4 & = & 0 \\  
(E3) &  \frac{1}{3} x_2 -x_3 -\frac{2}{3}x_4 & = & 0  \\
...
\[ \left\{ \begin{array}{lrcr} (E1) & x+\frac{3}{2}y-\frac{1}{2}z & = & \frac{1}{2} \\  
(E2) & -15y+4z & = & -3 \\  
