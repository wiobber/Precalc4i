...
% https://www.desmos.com/calculator/o4j9njdymv
 \begin{center}
\desmos{o4j9njdymv}{800}{600}
\end{center}
...
% https://www.desmos.com/calculator/hllfxtqklb
\begin{center}
\desmos{hllfxtqklb}{800}{600}
\end{center}
...
% https://www.desmos.com/calculator/thc8qkhmip
\begin{center}
\desmos{thc8qkhmip}{800}{600}
\end{center}
...
% https://www.desmos.com/calculator/8wbovtoot2
\begin{center}
\desmos{8wbovtoot2}{800}{600}
\end{center}
...
% https://www.desmos.com/calculator/carlygeuir
\begin{center}
\desmos{carlygeuir}{800}{600}
\end{center}
...
While we are able to sketch  $y = 1 - 4e^{2x}$ using the techniques in Section \ref{ExponentialFunctions},  the second equation is more difficult and so we opt to use Desmos.  We see the two graphs intersect at $(-0.6931,0) \approx (-\ln(2), 0)$ and $(-1.1744, 0.618) \approx  \left(\ln\left(\frac{-1 + \sqrt{5}}{4}\right),\frac{-1+\sqrt{5}}{2}\right)$.

% https://www.desmos.com/calculator/fxfqmpryud
\begin{center}
\desmos{fxfqmpryud}{800}{600}
\end{center}
...
% https://www.geogebra.org/3d/w8af728v
\begin{center}
\geogebra{w8af728v}{800}{600}
\end{center}
\end{enumerate}
...
\begin{explanation}  The key relationship between work and time which we use in this problem is: \[\text{amount of work done} = \text{rate of work} \cdot \text{time spent working} \]
...
Solving $1 = \frac{1}{12} t$, we get $t = 12$, so it takes Carl 12 hours to weed the garden on his own.\footnote{Carl would much rather spend his time writing open-source Mathematics texts than gardening anyway.} 
\end{explanation}
\end{example}
