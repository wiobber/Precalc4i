...
\tlabel[cc](4,-0.5){$x$}
\tlabel[cc](0.5,5){$y$}
\gclear \tlabelrect(0,3){$y=x+2$ \vphantom{ $\frac{x^2}{x^2}$} }
%\tlabel[cc](-2,1){$(-1,1)$}
%\tlabel[cc](2.75,4){$(2,4)$}
\tlabel[cc](2.5,2){$y=x^2$}
...
\tcaption{Graphing $f(x) = x^3-3x$ and $g(x) = x$}
\scriptsize
\tlpointsep{4pt}
...
\xmarks{-3 step 1 until 3}
\ymarks{1, 2, 3, 4}
\tcaption{`Filling up'  $R$ from bottom to top.}
\scriptsize
\tlpointsep{4pt}
\axislabels {x}{{$-3 \hspace{7pt}$} -3,{$-2 \hspace{7pt}$} -2,{$-1 \hspace{7pt}$} -1,{$1$} 1,{$2$} 2,{$3$} 3}
...
\xmarks{-3 step 1 until 3}
\ymarks{2, 3, 4}
\tcaption{`Filling up'  $R$ from left to right.}
\scriptsize
\tlpointsep{4pt}
...
\tlabel[cc](0.5,5){$y$}
\tlabel[cc](1.75,1){$y=1$}
\tlabel[cc](2.5,2){$x = \sqrt{y}$}
\tlabel[cc](1.5,0.5){$x = \sqrt{y}$}
\tlabel[cc](-2,0.5){$x = - \sqrt{y}$}
\gclear \tlabelrect(0,3){$x=y-2$ \vphantom{ $\frac{x^2}{x^2}$} }
%\tlabel[cc](-2,1){$(-1,1)$}
%\tlabel[cc](2.75,4){$(2,4)$}
\xmarks{-3 step 1 until 3}
\ymarks{1, 2, 4}
...
\ymarks{-2,-1,1,2}
\tlpointsep{4pt}
\axislabels {x}{{$-2 \hspace{15pt}$} -2, {$\hspace{7pt} 2$} 2}
\penwd{1.25pt}
...
\ymarks{-3,-1,1,2,3}
\tlpointsep{4pt}
\axislabels {x}{{$-5 \hspace{7pt}$} -5, {$2$} 2, {$3$} 3,{$4$} 4,{$5$} 5}
\penwd{1.25pt}
...
\ymarks{-3,-2,-1,1,2,3}
\tlpointsep{4pt}
\axislabels {x}{{$-3 \hspace{7pt}$} -3,{$-2 \hspace{7pt}$} -2,{$-1 \hspace{7pt}$} -1, {$\hspace{7pt} 2$} 2}
...
\tlpointsep{5pt}
\axislabels {x}{{$-2 \hspace{7pt}$} -2,  {$-1 \hspace{7pt}$} -1, {$1$} 1, {$2$} 2, {$4$} 4}
...
\tlabel(5,-0.5){$t$}
\tlabel(0.25,4){$s$}
\tlabel[cc](2.6666,-1.75){$t =2.\overline{6}$}
\tlabel[cc](4.75,2){$s =2.\overline{285714}$}
